.PHONY: start stop restart reset build-contracts build-artifacts-cargo build-optimized deploy-local deploy-local-no-build deploy-testnet deploy-mainnet dev dev-full indexer-dev build-indexer-release fetch-qa-ci-artifacts test-contracts coverage-contracts test-frontend test-frontend-charts test-e2e test-e2e-tx test-e2e-indexer-outage test-charts-integration tests-charts-integration lint lint-indexer-log-secrets lint-log-secrets check-launch-monitoring-docs check-fee-discount-tier-docs check-user-incident-faq-docs check-emergency-commands-docs check-deploy-trace-docs check-wasm-migration-rollback-docs check-deploy-config-docs check-test-evidence-gate-docs check-exploit-replay-matrix-docs check-launch-go-no-go-docs check-governance-emergency-rehearsal-docs check-ibc-hooks-deploy-docs check-extension-fee-guard-docs check-blacklist-decision-docs check-suspicious-activity-queries-docs check-anomaly-signals-docs check-incident-comms-templates-docs check-incident-template-docs check-pool-triage-docs verify-no-ibc-hooks-in-contracts rehearse-governance-emergency setup-hooks test-commit-msg-hook verify-commit-messages wait-localterra wait-healthy has-localterra help compose-ps start-qa qa-start stop-qa reset-qa smoke-pool-swap smoke-wrap-mapper-pause test-qa-fresh-volumes test-qa-verify-deploy test-qa-verify-deploy-config test-qa-redeploy-decision test-localterra-host-curl test-has-localterra test-setup-postgres test-setup-browser test-setup-cloud-agent-env qa-tunnel-help qa-verify-deploy qa-verify-deploy-config verify-issue-238 verify-issue-245 verify-issue-274 verify-issue-276 verify-issue-285 verify-issue-293 verify-issue-309 verify-issue-313 verify-issue-295 verify-issue-324 verify-issue-365 verify-issue-369 verify-issue-383 verify-issue-384 verify-issue-396 verify-issue-397 verify-issue-391 verify-issue-399 verify-issue-400 verify-issue-435 verify-issue-437 verify-issue-438 verify-issue-407 verify-issue-429 verify-issue-410 verify-issue-416 verify-issue-436 verify-issue-439 verify-issue-440 verify-issue-441 verify-issue-443 verify-issue-444 swarm-local swarm-launch swarm-stop test-swarm-liquidity swarm-bootstrap-liquidity setup-cloud-localterra setup-cloud-agent-env setup-indexer-postgres test-indexer-integration audit-smartcontracts audit-indexer audit-frontend gitleaks-detect verify-gitleaks
...
help:
	...
	@echo "QA server:       make start-qa | reset-qa | QA_FRESH_VOLUMES=1 make start-qa | QA_FETCH_CI_ARTIFACTS=1 make start-qa | stop-qa | qa-verify-deploy | qa-verify-deploy-config | test-qa-redeploy-decision"
	...
	@echo "Cloud Agent:     make setup-cloud-agent-env | setup-cloud-localterra | setup-indexer-postgres | test-setup-cloud-agent-env | test-indexer-integration | verify-issue-324 | verify-issue-365 | verify-issue-369 | verify-issue-391 | verify-issue-397 | verify-issue-399 | verify-issue-400 | verify-issue-435 | verify-issue-437 | verify-issue-438 | verify-issue-407 | verify-issue-429 | verify-issue-410 | verify-issue-416 | verify-issue-436 | verify-issue-439 | verify-issue-440 | verify-issue-441 | verify-issue-443 | verify-issue-444 | verify-issue-295 (needs make dev)"
