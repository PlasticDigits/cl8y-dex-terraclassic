...
# Forgejo #1234 — UpdateLimitOrderPrice + CleanLimitBook F6 code-id gate.
.PHONY: verify-issue-1234
verify-issue-1234:
...
# Forgejo #1222 — retail gas envelope vs wallet auto-fee census (docs/ADR only).
.PHONY: verify-issue-1222
verify-issue-1222:
	@chmod +x scripts/qa/verify-issue-1222.sh scripts/with-node.sh
	./scripts/qa/verify-issue-1222.sh

# Forgejo #1265 — remaining GET /route/solve failures census (docs/ADR only).
.PHONY: verify-issue-1265
verify-issue-1265:
...
# Forgejo #707 — integrator pool-only vs best-execution guidance (docs only).
.PHONY: verify-issue-707
verify-issue-707:
	@chmod +x scripts/qa/verify-issue-707.sh
	./scripts/qa/verify-issue-707.sh

# GitLab #708 — greedy book-first swap (opt-in; G1–G14).
verify-issue-708:
	@chmod +x scripts/qa/verify-issue-708.sh scripts/with-node.sh
	./scripts/qa/verify-issue-708.sh

# GitLab #709 — greedy query mutex, remainder_to_pool, pool_spot overflow (!480 leftover).
verify-issue-709:
	@chmod +x scripts/qa/verify-issue-709.sh
	./scripts/qa/verify-issue-709.sh

# GitLab #710 — greedy tax / pause / blacklist / AfterSwap L7 (!480 leftover).
verify-issue-710:
...
# Forgejo #1257 — USTR→USDT mixed 18/6 hop honesty + Expert no-waive ≥99%.
.PHONY: verify-issue-1257
verify-issue-1257:
	@chmod +x scripts/qa/verify-issue-1257.sh scripts/with-node.sh
	./scripts/qa/verify-issue-1257.sh

# Forgejo #1255 — Swap unlisted CW20 token_info amount scale (fail-closed, not ?? 6).
.PHONY: verify-issue-1255
verify-issue-1255:
	@chmod +x scripts/qa/verify-issue-1255.sh scripts/with-node.sh
	./scripts/qa/verify-issue-1255.sh
...
# #1240 — /protocol mixed-case product tickers (cUSTC / vFDUSD) not CSS-uppercase.
.PHONY: verify-issue-1240
verify-issue-1240:
...
verify-issue-1308:
	@chmod +x scripts/qa/verify-issue-1308.sh scripts/qa/verify-issue-519.sh scripts/qa/verify-issue-554.sh scripts/qa/verify-issue-1279.sh scripts/with-node.sh
...
# GitLab #703 — /protocol Monthly UTC chart phone x-axis (last 12 months + YY-MM).
.PHONY: verify-issue-703
verify-issue-703:
	@chmod +x scripts/qa/verify-issue-703.sh scripts/with-node.sh
	./scripts/qa/verify-issue-703.sh
...
# GitLab #1277 — trader rolling + lifetime raw volume NUMERIC(38, 0) (18-dec aggregator overflow).
.PHONY: verify-issue-1277
verify-issue-1277:
	@chmod +x scripts/qa/verify-issue-1277.sh scripts/setup-cloud-agent-indexer-postgres.sh
	./scripts/qa/verify-issue-1277.sh
...
# GitLab #705 — GET /candles newest-N + interval refit + chart-interval chip.
verify-issue-705:
	@chmod +x scripts/qa/verify-issue-705.sh scripts/setup-cloud-agent-indexer-postgres.sh scripts/with-node.sh
	./scripts/qa/verify-issue-705.sh
...
# GitLab #693 — /trade ticket Market default, flatten nested chrome, token-logo heading wash.
.PHONY: verify-issue-693
verify-issue-693:
	@chmod +x scripts/qa/verify-issue-693.sh scripts/with-node.sh
	./scripts/qa/verify-issue-693.sh
...
# Forgejo #1227 — UpdateLimitOrderPrice joins equal-price FIFO tail (keep order_id).
verify-issue-1227:
	@chmod +x scripts/qa/verify-issue-1227.sh
	./scripts/qa/verify-issue-1227.sh

# Forgejo #1219 — named min remaining at place + descending ladder (no Overflow sub).
verify-issue-1219:
	@chmod +x scripts/qa/verify-issue-1219.sh scripts/with-node.sh
	./scripts/qa/verify-issue-1219.sh
...
# #1228 — SendFrom listed-pair Sell allowance covers TaxPreview.debit (A-allow).
verify-issue-1228:
	@chmod +x scripts/qa/verify-issue-1228.sh
	./scripts/qa/verify-issue-1228.sh

# Forgejo #1267 — extra-debit Sell TaxPreview.debit > balance CTA gate.
.PHONY: verify-issue-1267
verify-issue-1267:
...
verify-issue-1237:
	@chmod +x scripts/qa/verify-issue-1237.sh scripts/with-node.sh
	./scripts/qa/verify-issue-1237.sh
...
# GitLab #698 — post-merge !474/!475 leftover verify (#694 #695). #699/#700 are dups.
.PHONY: verify-issue-698 verify-issue-699 verify-issue-700
verify-issue-698 verify-issue-699 verify-issue-700:
	@chmod +x scripts/qa/verify-issue-698.sh scripts/with-node.sh
	./scripts/qa/verify-issue-698.sh

# GitLab #701 — post-merge !477 leftover verify (#692).
.PHONY: verify-issue-701
verify-issue-701:
	@chmod +x scripts/qa/verify-issue-701.sh scripts/with-node.sh
	./scripts/qa/verify-issue-701.sh

# GitLab #702 — post-merge !476 leftover verify (#693).
.PHONY: verify-issue-702
verify-issue-702:
	@chmod +x scripts/qa/verify-issue-702.sh scripts/with-node.sh
	./scripts/qa/verify-issue-702.sh
...
# GitLab #706 — stale Vite lazy chunks after Coolify frontend roll.
.PHONY: verify-issue-706
verify-issue-706:
	@chmod +x scripts/qa/verify-issue-706.sh scripts/with-node.sh
	./scripts/qa/verify-issue-706.sh

# GitLab #711 — Swap query params on / and /swap (Uniswap/Pancake/Terra aliases).
.PHONY: verify-issue-711
verify-issue-711:
	@chmod +x scripts/qa/verify-issue-711.sh scripts/with-node.sh
	./scripts/qa/verify-issue-711.sh

# GitLab #713 — Swap URL rewrite, reverse quotes, Share, Create/Trade query prefill.
.PHONY: verify-issue-713
verify-issue-713:
...
.PHONY: verify-issue-1329
verify-issue-1329:
	@chmod +x scripts/qa/verify-issue-1329.sh
	./scripts/qa/verify-issue-1329.sh
