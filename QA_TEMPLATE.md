...
| 10.3.5 | Mute from shell | Click **Sound** / **Sound on** in header (desktop) or More sheet (mobile) so label becomes **Muted** / **Sound off** | Immediate silence — the mute click itself must not play a press sound | | |
...
| 10.3.8 | Unmute | Click **Muted** / **Sound off** to re-enable | Optional confirmation press on unmute; subsequent interactions audible again without hard refresh | | |
