...
- [`AGENTS_FRONTEND_CHARTS_PAIR_STATS.md`](./AGENTS_FRONTEND_CHARTS_PAIR_STATS.md) — Charts pair-detail 24h Vol (USD), not picker badges ([#565](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/565))
