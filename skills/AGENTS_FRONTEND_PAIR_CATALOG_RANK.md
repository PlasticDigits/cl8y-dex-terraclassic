...
- [`AGENTS_FRONTEND_CHARTS_PAIR_STATS.md`](./AGENTS_FRONTEND_CHARTS_PAIR_STATS.md) — Charts pair 24h **Vol (token)** / TWAP are a different surface; catalog badges ≠ pair Stats ([#564](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/564))
