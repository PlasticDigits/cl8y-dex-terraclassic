...
| **M602-2** | **P402-1.** Coolify frontend rebuild bakes `VITE_COMMUNITY_TAX_CODE_ID=11611` and the **11614** launcher. `https://dex.cl8y.com` More menu shows **Create Token**; `/token/create` is not the unavailable stub. Do **not** bake unused **11612** `terra1af9xm…`. |
