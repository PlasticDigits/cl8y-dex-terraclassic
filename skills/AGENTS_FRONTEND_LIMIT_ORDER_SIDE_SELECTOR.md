...
| [GitLab **#300**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/300) · [**#412**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/412) | **`/trade`** direction labels: **Buy {base}** / **Sell {base}** via [`tradeDirectionSideLabels.ts`](../frontend-dapp/src/utils/tradeDirectionSideLabels.ts) — ticket heading must match button verbs |
...
5. **`/trade` vs `/limits` labels**: on **`/trade`**, pass **`tradeDirectionSideLabels(base)`** into **`bidLabel` / `askLabel`** — CEX-standard **Buy {base}** / **Sell {base}** ([#412](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/412); supersedes [#300](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/300)). On **`/limits`**, keep escrow-oriented **Bid (escrow …)** / **Ask (escrow …)** copy.
