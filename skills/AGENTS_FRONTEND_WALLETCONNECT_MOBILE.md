...
7. **WC-M7 — In-app browser still works.** Opening the dApp inside Keplr / Lunc Dash / Galaxy Station’s in-app browser remains a valid alternate path. Document it in the Connect modal; do not remove it as “the” fix. Picker geometry for that chrome is [#632](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/632) / [`AGENTS_FRONTEND_PORTAL_LISTBOX_VIEWPORT.md`](./AGENTS_FRONTEND_PORTAL_LISTBOX_VIEWPORT.md) — do not document “use Chrome only” as the token-menu fix.
...
make verify-issue-1308   # Lunc Dash payload query + children 519/554 + 1279 docs pre-check; does not close device AC (cl8y-pm inbox after Coolify is leftover #1311)
make verify-issue-1311   # leftover #1311 (implement; child 1308; not leftover-complete)
# or:
...
- Connect modal list / logos / dismiss overlay: [`AGENTS_FRONTEND_WALLET_CONNECT_MODAL.md`](./AGENTS_FRONTEND_WALLET_CONNECT_MODAL.md) (**D1–D9**, [#672](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/672))
...
- Leftover Lunc Dash ops verify (pre-check only; device QA is cl8y-pm inbox): [`AGENTS_OPS_LUNCDASH_VERIFY.md`](./AGENTS_OPS_LUNCDASH_VERIFY.md) (**L1279-1–L1279-8**, [#1279](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1279)); `make verify-issue-1279`. Live pairing payload on `dex.cl8y.com` is [#1308](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1308) / **Q21**. Post-merge Coolify + device leftover: [#1311](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1311) / **Q24** / [ADR 0011](../docs/adr/0011-post-merge-leftover-1306-1309-1310.md) / [`AGENTS_POST_MERGE_OPS_1311.md`](./AGENTS_POST_MERGE_OPS_1311.md) (`make verify-issue-1311` implement). Do not reopen #1279.
