...
- `AddWhitelistedCodeId` while that id’s `REPORT.md` is **NO-GO**. 8266 is **GO** and listed on columbus-5; 11619 is **GO** and listed 2026-08-24; adopt pin **11626** is **GO** (stored 2026-08-24, list after this report — [#628](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/628)); still do **not** whitelist a LocalTerra store id or ALPHA **8654**.
...
- Whitelist a community-tax **LocalTerra** store id, or ALPHA **8654**. Columbus-5 **11611** REPORT is **GO** ([`codeids/11611/REPORT.md`](../cw20-codeid-audits/codeids/11611/REPORT.md)). Adopt pin **11626** REPORT is **GO** ([`codeids/11626/REPORT.md`](../cw20-codeid-audits/codeids/11626/REPORT.md)). The stub [`codeids/community-tax-token/REPORT.md`](../cw20-codeid-audits/codeids/community-tax-token/REPORT.md) stays a **NO-GO** placeholder. See [`AGENTS_COMMUNITY_TAX_CW20.md`](./AGENTS_COMMUNITY_TAX_CW20.md) (**O601-1–O601-7**). `make verify-issue-601` runs A-lcd/B-lt on pinned 11611 plus LocalTerra tax smoke. Tax-on DEX paths (router `trader`, AutoLP floor) are `make verify-issue-623` — **not** a substitute listing gate and **not** merged into B-lt.
