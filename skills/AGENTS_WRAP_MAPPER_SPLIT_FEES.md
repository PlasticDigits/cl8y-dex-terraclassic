...
4. Mapper set_fees / pause and mapper + treasury wasm migrate use the DEX 2-of-3 after the [#525](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/525) / [#526](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/526) app accepts and [#638](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/638) admin rotations (2026-08-26). Re-query config.governance and ContractInfo.admin separately. Current residuals: [#697](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/697).
