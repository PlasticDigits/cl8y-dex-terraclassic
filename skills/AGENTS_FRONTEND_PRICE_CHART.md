...
6. **Tests:** Extend **`lightweightChartsJsdomMock`** when adding series APIs (`createPriceLine`, `priceScale`, etc.). Prefer **`data-testid`** over canvas assertions in Vitest.
