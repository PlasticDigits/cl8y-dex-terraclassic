...
`VERIFY1300_SKIP_CHAIN=1` skips the `has-localterra` probe (make never executes the walks). `VERIFY1300_REQUIRE_CHAIN=1` fail-closes that probe. `VERIFY1300_LEFTOVER_E2E=1` stays SKIP until named.
