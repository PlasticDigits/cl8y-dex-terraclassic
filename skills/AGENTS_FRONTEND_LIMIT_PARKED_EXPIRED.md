...
- Indexer exposes **`GET /api/v1/pairs/{addr}/limit-placements`** with **`lifecycle_status`** (default feed = **`active` + `parked_expired`**) — [GitLab **#142**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/142), [`docs/indexer-invariants.md`](../docs/indexer-invariants.md).
