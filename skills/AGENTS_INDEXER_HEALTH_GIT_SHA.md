...
- **Don’t** treat **clean ahead** → **2(b)** (hotfix, no ledger surgery) as needing Stop. **Don’t** skip Start after dirty `idx_reclass` → **2(b)** — **start only the hotfix image**.
