...
7. **NetworkBadge vs ribbon ([#483](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/483)):** on ≥768px, do not reintroduce a duplicate header `NetworkBadge` next to theme/wallet — wallet chip + footer ribbon carry that signal.
8. **Header menus:** with the ribbon in the footer, open More / wallet menus no longer compete with an under-header ribbon band (historical [#486](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/486)).
