# Agent playbook: `/pool` sortable table (GitLab #547 / #655)

Audience: third-party agents changing the pool list, default rank, Charts deep links, `/pool` page chrome, or the **v2 LP USD** column.

**Issue:** [GitLab **#547**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/547) · [**#655**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/655) (v2 LP USD)  
**Invariants:** [`docs/frontend.md` § Liquidity pools list](../docs/frontend.md#liquidity-pools-list-indexer-vs-factory) (**P547-1–P547-10**, **P655-1–P655-8**)  
...
- **Don’t** invent pool USD from `volume_quote_24h`, CG `liquidity_in_usd`, hub-prices in the browser, or wallet LP balances ([#655](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/655)).
