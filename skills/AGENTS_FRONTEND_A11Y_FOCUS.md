...
| `frontend-dapp/src/index.css` | `--focus-ring`; `.input-glass` / `.btn-*` / shell nav `.app-*` / `.wallet-*` / `.tab-glass*` / `.wallet-option-card`; `.swap-io-amount-input` |
