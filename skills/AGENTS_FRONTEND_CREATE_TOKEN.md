...
| [`docs/frontend.md` § Create Token](../docs/frontend.md#create-token-community-tax) | Invariants **C593-1–C593-13**, **C604-1–C604-3**, **C605-1–C605-4** |
...
9. **C593-9 — extra-debit max.** Swap + Trade Market Max for this template uses sell extra-debit (`extraDebitSellBps` / TaxPreview). Do not offer 100% balance on a taxed sell. Manager-directory wallets skip extra-debit (**E609-7**); Extra exemptions hint must say buy, sell, and transfer.
