...
| [docs/frontend.md § Limit orders page — market data outage](../docs/frontend.md#limits-page-market-data-outage) | Page banner `limits-market-data-outage-banner`; book panel keeps `trade-book-unavailable-*` testids ([#218](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/218)) |
