...
- One-sided pool zap uses this Settings default (no on-card chips): [`AGENTS_FRONTEND_POOL_ONE_SIDED.md`](./AGENTS_FRONTEND_POOL_ONE_SIDED.md) (`#533` / **Z533-7**). Execution amounts follow those floors, not the optimistic quote: [`AGENTS_FRONTEND_POOL_ZAP_FLOORS.md`](./AGENTS_FRONTEND_POOL_ZAP_FLOORS.md) (`#559` / **Z559-1**)
