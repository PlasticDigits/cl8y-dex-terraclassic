...
- Swap query params still factory-gated: [`AGENTS_FRONTEND_SWAP_QUERY_PARAMS.md`](./AGENTS_FRONTEND_SWAP_QUERY_PARAMS.md) ([GitLab **#711**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/711))
