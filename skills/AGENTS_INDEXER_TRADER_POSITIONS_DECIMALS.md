...
- [`AGENTS_INDEXER_TRADER_ROLLING_NUMERIC.md`](./AGENTS_INDEXER_TRADER_ROLLING_NUMERIC.md) — rolling volume is **`NUMERIC(38, 0)`**, not this `(78, 18)` P&L type ([#1277](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1277))
