...
- Gas limits / fee envelope: [`AGENTS_TERRACLASSIC_GAS.md`](./AGENTS_TERRACLASSIC_GAS.md) — LocalTerra wallet matrix ([#235](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/235)); mixed hybrid router hops + Station mobile auto-gas residual ([#679](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/679), **G-AUTO-8**)
