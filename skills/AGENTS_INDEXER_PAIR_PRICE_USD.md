...
- [`AGENTS_FRONTEND_CHARTS_PAIR_STATS.md`](./AGENTS_FRONTEND_CHARTS_PAIR_STATS.md) — Charts pair Stats **Vol (USD)** uses `stats.volume_usd`; token vols stay raw in JSON ([#564](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/564))
