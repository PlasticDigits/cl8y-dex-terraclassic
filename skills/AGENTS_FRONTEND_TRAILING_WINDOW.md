...
Audience: third-party agents changing Charts overview, pair 24h Stats, Protocol global volume, Pool **Vol** header, or `StatBox` `title` / `aria-label`.

**Issue:** [GitLab **#576**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/576)  
**Invariants:** [`docs/indexer-invariants.md`](../docs/indexer-invariants.md) row **Trailing window copy (#576)**; [`docs/frontend.md`](../docs/frontend.md) § [Charts overview](../docs/frontend.md#charts-overview), [Charts pair 24h stats](../docs/frontend.md#charts-pair-stats), [Protocol](../docs/frontend.md#protocol-page)  
...
- **Do** reuse [`TRAILING_24H_VOLUME_TITLE`](../frontend-dapp/src/utils/trailingWindowCopy.ts) on Charts overview, pair Vol, and Protocol 24h.
...
- **Don’t** retitle the Protocol UTC grain chart (Hourly / Daily / Monthly, [#668](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/668)) as Last 24h/7d/30d — that chart is calendar buckets, not the trailing tiles.
...
| `frontend-dapp/src/pages/ChartsPage.tsx` | Overview + pair Vol + SORT label |
...
- [`AGENTS_FRONTEND_CHARTS_OVERVIEW.md`](./AGENTS_FRONTEND_CHARTS_OVERVIEW.md) — USD-only overview (**C1–C9**, #548)
