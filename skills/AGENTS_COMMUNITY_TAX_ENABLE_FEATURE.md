...
8. **T606-8 — columbus-5 migrate.** Token **11611** + launcher **11614** need a CMM / DEX 2-of-3 **migrate** before live Enable Feature works. A dApp-only payee change was the no-migrate alternative and was **not** chosen.
