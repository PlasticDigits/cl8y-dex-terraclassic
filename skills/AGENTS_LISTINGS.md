...
| `/cg/*` `/cmc/*` crawler shape | [#224](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/224) | [`docs/CG_CMC_COMPLIANCE.md`](../docs/CG_CMC_COMPLIANCE.md) |
...
| **L639-4** | Llama = #631, Keplr = #629, crawler shape = #224. Do not reopen those here. |
...
5. **GeckoTerminal is not Uniswap-V2 auto-detect.** Terra Classic is absent from GT networks; child vendors non-EVM adapters under `scripts/geckoterminal/` only if product wants a second on-chain indexer besides Llama.
