...
- **Swap max spread / price impact UX (dApp preflight + error copy):** [**#134**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/134), [`docs/swap-max-spread-ux.md`](../docs/swap-max-spread-ux.md), [`swapMaxSpread.ts`](../frontend-dapp/src/utils/swapMaxSpread.ts), [`swapRoutePreflight.ts`](../frontend-dapp/src/services/terraclassic/swapRoutePreflight.ts), [`humanizeTerraTxError.ts`](../frontend-dapp/src/utils/humanizeTerraTxError.ts)
- Dev wallet / mnemonic bundle safety: [`AGENTS_BUNDLE_DEV_WALLET.md`](./AGENTS_BUNDLE_DEV_WALLET.md)  
- Gas limits for swap shapes: [`AGENTS_TERRACLASSIC_GAS.md`](./AGENTS_TERRACLASSIC_GAS.md) (includes **min uluna gas price** / limit-order **insufficient fee** / **Station `experimentalSuggestChain` pre+post connect** / **cosmes `KeplrExtension` per-sign `preferNoSetFee` patch** / **Station LocalTerra chain (`chainId` case-insensitive) or Ledger → amino signing** in patched **`StationController`** / **verify Station + Keplr** — [GitLab **#127**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/127); **#115** buffer parity with [`packages/localnet-trading-swarm/src/gas.ts`](../packages/localnet-trading-swarm/src/gas.ts))
