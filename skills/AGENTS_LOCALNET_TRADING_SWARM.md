...
- Limit cancel UX + indexer placement feed (no stale cancelled rows; humanized CosmWasm errors): [**#135**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/135), [`limitOrderCancelUserMessage.ts`](../frontend-dapp/src/utils/limitOrderCancelUserMessage.ts), [`docs/limit-orders.md`](../docs/limit-orders.md#dapp-retail-form-wires-invariants)
