...
| Area | Path |
|------|------|
| Migration | [`indexer/migrations/20260531143000_pair_volume_24h_rollup.sql`](../indexer/migrations/20260531143000_pair_volume_24h_rollup.sql) |
...
- **`pair_volume_24h` seed** in integration tests: call `refresh_pair_volumes` after swap seed ([`tests/common/mod.rs`](../indexer/tests/common/mod.rs)).
