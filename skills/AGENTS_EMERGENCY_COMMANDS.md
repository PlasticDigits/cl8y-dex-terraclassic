...
| [`docs/templates/incident-dex-indexer.md`](../docs/templates/incident-dex-indexer.md) | Mitigation step links to the cookbook; [Communications templates](../docs/templates/incident-dex-indexer.md#appendix-communications-templates-sec-g05) for announcements |
