...
**#581 / 8266:** F6 is live on columbus-5 (factory **11602** / 1.9.0, pairs **11601** / 1.15.0, `config.pair_code_id` **11601** — [#584](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/584)). Template **GO** is [`cw20-codeid-audits/codeids/8266/REPORT.md`](../cw20-codeid-audits/codeids/8266/REPORT.md) ([#589](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/589) harness). DEX 2-of-3 listed **8266** 2026-08-22 (height **30060600**, `GetWhitelistedCodeIds` **`[6036, 8266, 10184]`**). Do **not** whitelist a LocalTerra store id. Do **not** whitelist ALPHA **8654**. SpaceUSD/UST1 create+provide stays on [#558](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/558). A byte-identical optimizer rebuild is an **optional appendix** ([`audits/CW20-8266-581-hash-repro.md`](../audits/CW20-8266-581-hash-repro.md)). CertiK match is not required; listing all 8266 instantiations is accepted (LUNC fee). Future F6 wasm upgrades still use [`scripts/upgrade-582-code-id-pin.sh`](../scripts/upgrade-582-code-id-pin.sh). Playbook: [`AGENTS_CW20_CODE_ID_AUDIT.md`](./AGENTS_CW20_CODE_ID_AUDIT.md); `make verify-issue-589`.
