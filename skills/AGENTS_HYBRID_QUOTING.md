...
- Community tax router hops are **Honest** ([GitLab **#607**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/607) option 1 / **T592-13**): [`AGENTS_COMMUNITY_TAX_ROUTER.md`](./AGENTS_COMMUNITY_TAX_ROUTER.md). Single-hop pair `Send+Swap` still taxes; `swapOpsRequireRouter` hops do not. Do not add pair/router FoT math.
