...
> **Historical note (Jun 2026, [#416](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/416)):** Rows **9.2.6** and **10.1.5** below reference a **footer** theme toggle — superseded by the **header** theme control ([#170](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/170)). Use [`QA_TEMPLATE.md`](QA_TEMPLATE.md) §9.2.6 / §10.1.5 for current steps.
...
> **Superseded (post–Mar 2026):** Leap was removed from the product ([GitLab #159](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/159)). Rows 1.3.1–1.3.10 below are **historical** only.
...
| # | Test Case | Steps | Expected Result | Status | Notes |
|---|-----------|-------|-----------------|--------|-------|
| 2.3.1 | Default slippage | Open swap page fresh | Slippage is 5% (#497) | | |
...
| 9.2.6 | Footer theme toggle | View footer | Dark/Light theme toggle present | ⏭️ | **Historical** — toggle moved to header ([#170](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/170)); see `QA_TEMPLATE.md` §9.2.6 |
...
| 10.1.5 | Theme toggle | Click toggle in footer | Theme switches immediately | ⏭️ | **Historical** — use header toggle per `QA_TEMPLATE.md` §10.1.5 |
