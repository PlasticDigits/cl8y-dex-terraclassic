...

{
  ...
  echo "# CL8Y Legal clickwrap (GitLab #517) — defaults are baked into the frontend; set only to override staging Legal."
  echo "# VITE_LEGAL_API_BASE_URL=https://api.terms.cl8y.com"
  echo "# VITE_LEGAL_TERMS_BASE_URL=https://terms.cl8y.com"
  echo "# VITE_LEGAL_PROPERTY=dex.cl8y.com"
