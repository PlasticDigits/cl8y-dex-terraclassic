...
| 11611 | Community tax (#601) REPORT **GO**; listed 2026-08-23. Live whitelist **`[6036, 8266, 10184, 11611]`**. Canonical launcher `terra126pr5323xkhwas7y03azv48sqr2fy3fxxg0sxu8xhmjdxr8v5tzqahzwze` is code **11620** (was 11614). Token rotate **11619** REPORT **GO**; not listed until `AddWhitelistedCodeId`. Unused 11612 `terra1af9xm…` has no `CreateToken`. Do **not** whitelist 11612/11613/11614/11620/11621. Gate: `make verify-issue-601` (A-lcd/B-lt + LocalTerra smoke). Post-merge Coolify: `make verify-issue-602` (**Q9**). |
