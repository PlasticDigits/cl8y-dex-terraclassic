#!/usr/bin/env bash
# Forgejo #1290 — implement PR for hub wrap cLUNC vs CEX USTC/LUNC (#1240 P1240 bundle).
# Extends verify-issue-1240 with hubPriceTicker Vitest + Playwright protocol-page (5 workers).
#
# Refs: skills/AGENTS_FRONTEND_PROTOCOL_STATS.md (P1240),
...
echo "════════════════════════════════════════════════════════════════"
echo "  #1290 — hub wrap cLUNC vs CEX USTC/LUNC (bundle #1240 P1240)"
echo "════════════════════════════════════════════════════════════════"
...
run_step "docs: #1290 verify crosslink" \
...
echo ""
echo "  #1290 hub wrap vs CEX native labels verified."
