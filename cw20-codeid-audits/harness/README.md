...
| **B-tax-on** | Named community-tax suite after `RegisterListedPair`: TaxPreview extra-debit, pair-direct sell/buy from `pick_trader` (non-treasury), official-router ≥2hop `trader`, spoof-trader negative, missing-trader fail-closed, limit Place 1:1, AutoLP floor | `LAYER_B_TAX_ON=1` / `make verify-issue-623`. Implemented by [`scripts/layer-b-tax-on.sh`](../scripts/layer-b-tax-on.sh) + [`scripts/lib-tax-on.sh`](../scripts/lib-tax-on.sh). **Not** a substitute listing gate for other templates. Never whitelist columbus-5 **11611** / **11619** / **8654** from this evidence. Seed-path buy leftover: [#625](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/625). Playbook: [`AGENTS_CW20_CODE_ID_TAX_ON.md`](../../skills/AGENTS_CW20_CODE_ID_TAX_ON.md). |
