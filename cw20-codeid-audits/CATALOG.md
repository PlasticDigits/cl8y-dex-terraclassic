...
| In-repo `cl8y-community-tax-token` ([#592](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/592)) | DEX-safe buy/sell/transfer (inbound 1:1). **Not listable** until LCD store + `codeids/<id>/REPORT.md` **GO**. Stub: [`codeids/community-tax-token/REPORT.md`](codeids/community-tax-token/REPORT.md) (**NO-GO**). Must **not** match 8654 inbound FoT. |
