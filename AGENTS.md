...
- [skills/AGENTS_FRONTEND_CREATE_TOKEN.md](skills/AGENTS_FRONTEND_CREATE_TOKEN.md) — Create Token + manager console (**C593-1–C593-13**, [#593](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/593); **C604-1–C604-3**, [#604](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/604); **C605-1–C605-3**, [#605](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/605)); `make verify-issue-593` · `make verify-issue-604` · `make verify-issue-605`; post-merge Coolify/LocalTerra [#602](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/602)
