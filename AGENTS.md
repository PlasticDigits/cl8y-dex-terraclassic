...
make verify-issue-1305                   # #1305 post-merge PRs 1302–1304 leftover (children 1290 SKIP_E2E + 1277 + Coolify)
...
| Post-merge PRs 1302–1304 leftover | `make verify-issue-1305` |
...
- [skills/AGENTS_POST_MERGE_OPS_1305.md](skills/AGENTS_POST_MERGE_OPS_1305.md) — post-merge PRs 1302–1304 leftover verify (**M1305-1–M1305-8**, [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305)); [ADR 0010](docs/adr/0010-post-merge-leftover-1302-1304.md); quote-agnostic hub HTTP + glance `cUSTC / USD` + `cLUNC / USD` + manual indexer deploy if #1276 checkbox off; `make verify-issue-1305` (implement)
