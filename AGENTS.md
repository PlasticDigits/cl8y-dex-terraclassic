...
- [skills/AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md](skills/AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md) — Swap/Trade extra-debit Sell CTA when `TaxPreview.debit > balance` (**S1267-1–S1267-8**, [#1267](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1267)); `make verify-issue-1267`
