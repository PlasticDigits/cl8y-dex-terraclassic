...
make verify-issue-1305                   # #1305 post-merge PRs 1302–1304 leftover (implement; children 1290 SKIP_E2E + 1277)
...
| Post-merge PRs 1302–1304 leftover | `make verify-issue-1305` (implement) |
...
- [skills/AGENTS_INDEXER_TRADER_ROLLING_NUMERIC.md](skills/AGENTS_INDEXER_TRADER_ROLLING_NUMERIC.md) — trader rolling + lifetime raw volume **`NUMERIC(38, 0)`** so 18-dec `SUM(offer_amount)` cannot fail the aggregator (**R1277-1–R1277-8**, [#1277](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1277)); Coolify heal leftover [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305); `make verify-issue-1277`
...
- [skills/AGENTS_POST_MERGE_OPS_1305.md](skills/AGENTS_POST_MERGE_OPS_1305.md) — post-merge PRs 1302–1304 leftover verify (**M1305-1–M1305-8**, [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305)); [ADR 0010](docs/adr/0010-post-merge-leftover-1302-1304.md); leftover-1 is glance `cUSTC / USD` + `cLUNC / USD` vs CEX + click vFDUSD (HTTP `cLUNC` is not leftover-1) + leftover-complete close-comment (not `GET /health` / green make) + manual indexer deploy if #1276 checkbox off; `make verify-issue-1305` (implement)
