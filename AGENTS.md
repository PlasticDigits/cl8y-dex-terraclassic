...
- [skills/AGENTS_TERRACLASSIC_GAS.md](skills/AGENTS_TERRACLASSIC_GAS.md) — Terra Classic fee envelopes; wrap+≥2hop LUNC↔USTR combo overhead + Swap **Network fee (est.) ~X LUNC** ([#587](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/587)); `make verify-issue-587`
