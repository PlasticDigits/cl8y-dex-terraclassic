...
make verify-issue-1277                   # #1277 trader rolling raw volume NUMERIC(38, 0) + skip heal
...
- [skills/AGENTS_INDEXER_TRADER_ROLLING_VOLUME.md](skills/AGENTS_INDEXER_TRADER_ROLLING_VOLUME.md) — trader rolling + lifetime raw volume **`NUMERIC(38, 0)`** + skip-class heal (**V1277-1–V1277-8**, [#1277](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1277)); [ADR 0005](docs/adr/0005-trader-rolling-volume-numeric.md); `make verify-issue-1277`
