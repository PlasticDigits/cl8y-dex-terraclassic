...
- [skills/AGENTS_POST_MERGE_OPS_1305.md](skills/AGENTS_POST_MERGE_OPS_1305.md) — post-merge PRs 1302–1304 leftover verify (**M1305-1–M1305-8**, [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305)); [ADR 0010](docs/adr/0010-post-merge-leftover-1302-1304.md); leftover-1 is glance `cUSTC / USD` + `cLUNC / USD` (HTTP `cLUNC` is not leftover-1) + manual indexer deploy if #1276 checkbox off; `make verify-issue-1305` (implement)
