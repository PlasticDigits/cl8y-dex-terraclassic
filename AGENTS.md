...
make verify-issue-1264                   # #1264 USTC→USTR wrap+2hop pool-only envelope (no AC1 raise)
...
make verify-issue-1311                   # #1311 post-merge PRs 1306/1309/1310 leftover (implement; child 1308; device AC is cl8y-pm after Coolify)
...
| Post-merge PRs 1306/1309/1310 leftover | `make verify-issue-1311` (implement; child 1308) |
...
- [skills/AGENTS_FRONTEND_SWAP_ROUTE_DISPLAY.md](skills/AGENTS_FRONTEND_SWAP_ROUTE_DISPLAY.md) — single execution-aligned **Route** row on Swap and `/trade` market quote (#158, #302); Trade market GET `/route/solve` default (#501); always-on hybrid (#596); remaining-failures census **Stay** ([#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md))
- [skills/AGENTS_HYBRID_QUOTING.md](skills/AGENTS_HYBRID_QUOTING.md) — hybrid quote = execute; Swap + Trade market share `quoteCw20ViaRouteSolve` (#418, #501); hop-offer partition (#1280) [`AGENTS_HYBRID_HOP_OFFER.md`](skills/AGENTS_HYBRID_HOP_OFFER.md); remaining-failures census **Stay** ([#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md), **R-CENSUS-1–R-CENSUS-8**); regression `make verify-issue-501` · `make verify-issue-1280` · `make verify-issue-1265`
- [skills/AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md](skills/AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md) — indexer GET `/route/solve` global solver contract + remaining-failures census **Stay** ([#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md)); `make verify-issue-1265`
...
- [skills/AGENTS_FRONTEND_HYBRID_ALWAYS_ON.md](skills/AGENTS_FRONTEND_HYBRID_ALWAYS_ON.md) — official dApp never opts out of best-execution hybrid (**H596-1–H596-8**, [#596](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/596)); remaining-failures census **Stay** ([#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md)); `make verify-issue-596` · `make verify-issue-1265`
...
- [skills/AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md](skills/AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md) — `/protocol` top-5 trailing 30d pair USD + current TVL + vol/LP (**I1263-1–I1263-8**, [#1263](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1263)); `make verify-issue-1263`
...
- [skills/AGENTS_POST_MERGE_OPS_1311.md](skills/AGENTS_POST_MERGE_OPS_1311.md) — post-merge PRs 1306/1309/1310 leftover verify (**M1311-1–M1311-8**, [#1311](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1311)); [ADR 0011](docs/adr/0011-post-merge-leftover-1306-1309-1310.md); Coolify `payload` cut + device AC2/AC3/AC7 (**AC3** is QA_TEMPLATE **1.5.1c**); `make verify-issue-1311` (implement)
...
- [skills/AGENTS_FRONTEND_SWAP_USTR_USDT_SCALE.md](skills/AGENTS_FRONTEND_SWAP_USTR_USDT_SCALE.md) — USTR→USDT mixed 18/6 hop honesty + Expert no-waive ≥99% (**Q1257-1–Q1257-8**, [#1257](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1257)); remaining-failures **F1** stays this ticket ([#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md)); `make verify-issue-1257` · `make verify-issue-1265`
