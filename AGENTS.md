...
- **`pre-push`** — blocks pushes that include **new** commits whose bodies still violate the policy (catches `git commit --no-verify`). New branches scan only commits not already on that remote (`git rev-list <oid> --not --remotes=<remote>`). Skips commits already on `origin/main` so merging main into a feature branch does not re-reject historical main commits ([#1286](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1286) / [#1287](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1287)); playbook [`skills/AGENTS_GIT_COMMIT_HOOKS.md`](skills/AGENTS_GIT_COMMIT_HOOKS.md); `make verify-issue-1287`.
...
make verify-issue-1264                   # #1264 USTC→USTR wrap+2hop pool-only envelope (AC1 measured; keep 2.71M)
make verify-issue-1218                   # #1218 wrap-enter GET /route/solve + skip-unusable top-K
make verify-issue-1280                   # #1280 hop-offer hybrid partition (Policy A hop0-only GET)
...
make verify-issue-1255                   # #1255 Swap unlisted CW20 token_info amount scale (Vitest)
...
make verify-issue-1219                   # #1219 named min remaining at place + descending ladder
...
make verify-issue-1228                   # #1228 SendFrom listed-pair Sell allowance = TaxPreview.debit
make verify-issue-1267                   # #1267 extra-debit Sell TaxPreview.debit > balance (Vitest + docs)
make verify-issue-1285                   # #1285 TaxPreview send_msg + hop_trader_debit leftover (Vitest + docs)
...
make verify-issue-1237                   # #1237 SettingsBatch AutoLP/minter no-op (T592-4 sister identity)
...
make verify-issue-687                    # closed #687 regression gate: DeFiLlama fees partial SUM + adapter start / 404
...
make verify-issue-1277                   # #1277 trader rolling raw volume NUMERIC(38,0) + aggregator overflow
make verify-issue-522                    # #522 pair Price (USD) human scale + oracle conversion
make verify-issue-1258                   # #1258 USDT-quoted Charts Price (USD) + 24h OHLC catalog pin
...
| Limit place min remaining | `make verify-issue-1219` |
...
- [skills/AGENTS_FRONTEND_WALLETCONNECT_MOBILE.md](skills/AGENTS_FRONTEND_WALLETCONNECT_MOBILE.md) — WalletConnect same-device mobile pairing (deep-link + copy, not QR-only; **WC-M1–WC-M12**, [#519](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/519) / [#554](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/554) / [#566](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/566) / [#658](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/658)); leftover Lunc Dash ops verify [#1279](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1279) [`AGENTS_OPS_LUNCDASH_VERIFY.md`](skills/AGENTS_OPS_LUNCDASH_VERIFY.md) (**L1279-1–L1279-8**); Lunc Dash `payload` query [#1308](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1308); `make verify-issue-519` · `make verify-issue-554` · `make verify-issue-566` · `make verify-issue-658` · `make verify-issue-1279` · `make verify-issue-1308`
- [skills/AGENTS_OPS_LUNCDASH_VERIFY.md](skills/AGENTS_OPS_LUNCDASH_VERIFY.md) — leftover Lunc Dash WalletConnect ops verify (**L1279-1–L1279-8**, [#1279](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1279)); pre-check `make verify-issue-1279`; device QA 1.5 is cl8y-pm inbox cards. Live pairing payload: `make verify-issue-1308` ([#1308](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1308))
...
- [skills/AGENTS_FRONTEND_SWAP_ROUTE_DISPLAY.md](skills/AGENTS_FRONTEND_SWAP_ROUTE_DISPLAY.md) — single execution-aligned **Route** row on Swap and `/trade` market quote (#158, #302); Trade market GET `/route/solve` default (#501); always-on hybrid (#596); accepted census **Stay** (closed [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md)); separate route-display follow-up [#1330](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1330)
- [skills/AGENTS_HYBRID_QUOTING.md](skills/AGENTS_HYBRID_QUOTING.md) — hybrid quote = execute; Swap + Trade market share `quoteCw20ViaRouteSolve` (#418, #501); hop-offer partition (#1280) [`AGENTS_HYBRID_HOP_OFFER.md`](skills/AGENTS_HYBRID_HOP_OFFER.md); accepted census **Stay** (closed [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md), **R-CENSUS-1–R-CENSUS-8**, merged [PR #1289](https://git.cl8y.com/code/cl8y-dex-terraclassic/pulls/1289)); regression `make verify-issue-501` · `make verify-issue-1280` · `make verify-issue-1265`
- [skills/AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md](skills/AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md) — indexer GET `/route/solve` global solver contract + accepted failure census **Stay** (closed [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md), merged [PR #1289](https://git.cl8y.com/code/cl8y-dex-terraclassic/pulls/1289)); `make verify-issue-1265`
- [skills/AGENTS_FRONTEND_SWAP_ROUTE_DISPLAY.md](skills/AGENTS_FRONTEND_SWAP_ROUTE_DISPLAY.md) — single execution-aligned **Route** row on Swap and `/trade` market quote (#158, #302); Trade market GET `/route/solve` default (#501); always-on hybrid (#596); wrap-enter solver hops (#1218)
- [skills/AGENTS_HYBRID_QUOTING.md](skills/AGENTS_HYBRID_QUOTING.md) — hybrid quote = execute; Swap + Trade market share `quoteCw20ViaRouteSolve` (#418, #501); hop-offer partition (#1280) [`AGENTS_HYBRID_HOP_OFFER.md`](skills/AGENTS_HYBRID_HOP_OFFER.md); wrap-enter native map (#1218) [`AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md`](skills/AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md); regression `make verify-issue-501` · `make verify-issue-1280` · `make verify-issue-1218`
- [skills/AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md](skills/AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md) — native wrap-enter / unwrap-exit GET `/route/solve` (**H1218-1–H1218-8**, [#1218](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1218)); `make verify-issue-1218`
...
- [skills/AGENTS_FRONTEND_HYBRID_ALWAYS_ON.md](skills/AGENTS_FRONTEND_HYBRID_ALWAYS_ON.md) — official dApp never opts out of best-execution hybrid (**H596-1–H596-8**, [#596](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/596)); accepted remaining-failures census **Stay** (closed [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md)); `make verify-issue-596` · `make verify-issue-1265`
...
- [skills/AGENTS_COMMUNITY_TAX_CW20.md](skills/AGENTS_COMMUNITY_TAX_CW20.md) — community tax CW20 template + launcher + AutoLP (**T592-1–T592-13**, [#592](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/592); **O601-1–O601-7**, [#601](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/601); **A-allow** SendFrom allowance [#1228](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1228)); `make verify-issue-592` · `make verify-issue-601` · `make verify-issue-1228`
...
- [skills/AGENTS_COMMUNITY_TAX_AUTOLP.md](skills/AGENTS_COMMUNITY_TAX_AUTOLP.md) — AutoLP factory-listed pair + skim floor (**M610-1–M610-8**, [#610](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/610)); settings no-op is sister `GetConfig` (**T592-4**, [#1237](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1237)); `make verify-issue-610` · `make verify-issue-1237`
...
- [skills/AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md](skills/AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md) — Swap/Trade extra-debit Sell CTA when `TaxPreview.debit > balance` (**S1267-1–S1267-8**, [#1267](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1267); **S1285-1–S1285-4**, [#1285](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1285)); `make verify-issue-1267` · `make verify-issue-1285`
...
- [skills/AGENTS_INDEXER_ROUTE_SOLVE_PROGRESS.md](skills/AGENTS_INDEXER_ROUTE_SOLVE_PROGRESS.md) — distant-pair latency + `route/solve/progress` poll (#485); LCD-heavy + discount cache ([#694](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/694)); accepted **F5** failure census (closed [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md))
...
- [skills/AGENTS_FRONTEND_PROTOCOL_STATS.md](skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) — `/protocol` global USD stats + unified oracle card + pool TVL + treasury fees + inline Δ% / UTC grain volume + Δ% grouped with headline + liquidity 24h-only / denser x-axis + Volume/Liquidity/Fees metric toggle + phone Monthly `YY-MM` (**P550-1–P550-12**, **P569-1–P569-8**, **PFee-1–PFee-13**, **P652-1–P652-7**, **P667-1–P667-4**, **P668-1–P668-9**, **P689-1–P689-8**, **P703-1–P703-8**, **P1240-1–P1240-8**, **P1263-1–P1263-8**, [#550](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/550) / [#569](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/569) / [#586](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/586) / [#614](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/614) / [#652](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/652) / [#667](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/667) / [#668](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/668) / [#677](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/677) / [#689](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/689) / [#703](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/703)); `make verify-issue-550` · `make verify-issue-569` · `make verify-issue-586` · `make verify-issue-614` · `make verify-issue-652` · `make verify-issue-667` · `make verify-issue-668` · `make verify-issue-689` · `make verify-issue-677` · `make verify-issue-703` · `make verify-issue-1240` · `make verify-issue-1263`
...
- [skills/AGENTS_DEFILLAMA.md](skills/AGENTS_DEFILLAMA.md) — DeFiLlama TVL/volume/fees listing + UTC-day indexer API (**L631-1–L631-11**, **L687-1–L687-8**, [#631](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/631) / closed [#687](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/687); upstream [#8987](https://github.com/DefiLlama/dimension-adapters/pull/8987), ops record [#688](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/688)); `make verify-issue-631` · `make verify-issue-687`
...
- [skills/AGENTS_INDEXER_TRADER_ROLLING_NUMERIC.md](skills/AGENTS_INDEXER_TRADER_ROLLING_NUMERIC.md) — trader rolling + lifetime raw volume **`NUMERIC(38, 0)`** so 18-dec `SUM(offer_amount)` cannot fail the aggregator (**R1277-1–R1277-8**, [#1277](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1277)); `make verify-issue-1277`
...
- [skills/AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md](skills/AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md) — `/protocol` top-5 trailing 30d pair USD + current TVL + vol/LP (**I1263-1–I1263-8**, [#1263](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1263)); pending CMM-held LP / trading-fee bps extension (**I1317-1–I1317-5**, [#1317](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1317); not implemented); `make verify-issue-1263` is baseline only
...
- [skills/AGENTS_TERRACLASSIC_GAS.md](skills/AGENTS_TERRACLASSIC_GAS.md) — Terra Classic fee envelopes; wrap+≥2hop LUNC↔USTR combo ([#587](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/587)); USTC→USTR columbus-5 AC1 measured **2,630,228** under 2.71M ([#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264), **G1264-1–G1264-8**); mixed hybrid+pool router hops ([#679](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/679)); unwrap+≥2hop USTR→USTC combo ([#599](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/599)); post-merge E9/columbus-5 ([#600](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/600)); greedy book-first gas (**G13**, [#708](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/708)); remaining-gap census **Stay** ([#1222](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1222), **G-CENSUS-1–G-CENSUS-8**, [ADR 0004](docs/adr/0004-terraclassic-retail-gas-census.md)); Swap **Network fee (est.) ~X LUNC**; `make verify-issue-587` · `make verify-issue-1264` · `make verify-issue-679` · `make verify-issue-599` · `make verify-issue-600` · `make verify-issue-708` · `make verify-issue-709` · `make verify-issue-710` · `make verify-issue-1222`
...
- [skills/AGENTS_TWAP_CUMULATIVE_U256.md](skills/AGENTS_TWAP_CUMULATIVE_U256.md) — TWAP `price × dt` and cumulative add are `Uint256`, stored `u128` JSON zero-extends (**O1322-1–O1322-8**, [#1224](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1224) / [#1322](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1322)); do not wrap or saturate; live-pair migrate [#1324](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1324) preflights missing-key backfill [#1232](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1232); `make verify-issue-1224` · `make verify-issue-1322`
...
- [skills/AGENTS_REBALANCE_ORACLE_MINT_SWAP_BURN.md](skills/AGENTS_REBALANCE_ORACLE_MINT_SWAP_BURN.md) — 1 UST1 = $1 + LUNC/USTC oracle mint/swap (no LP), then burn leftover ([`scripts/rebalance-oracle-mint-swap-burn.sh`](scripts/rebalance-oracle-mint-swap-burn.sh))
- cLUNC/cUSTC v2 LP to $10k in USD rungs → CMM: [`scripts/rebalance-mint-clunc-custc-lp.sh`](scripts/rebalance-mint-clunc-custc-lp.sh) / [`docs/runbooks/rebalance-mint-clunc-custc-lp.md`](docs/runbooks/rebalance-mint-clunc-custc-lp.md)
...
- [skills/AGENTS_FRONTEND_SWAP_USTR_USDT_SCALE.md](skills/AGENTS_FRONTEND_SWAP_USTR_USDT_SCALE.md) — USTR→USDT mixed 18/6 hop honesty + Expert no-waive ≥99% (**Q1257-1–Q1257-8**, closed [#1257](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1257)); F1 census record [ADR 0007](docs/adr/0007-route-solve-remaining-failures.md) / closed [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265); `make verify-issue-1257` · `make verify-issue-1265`
- [skills/AGENTS_FRONTEND_SWAP_AMOUNT_SCALE.md](skills/AGENTS_FRONTEND_SWAP_AMOUNT_SCALE.md) — Swap / Trade unlisted CW20 execute scale from LCD `token_info` / indexer (**Q1255-1–Q1255-8**, [#1255](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1255)); `make verify-issue-1255`
