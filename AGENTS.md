...
- [skills/AGENTS_HYBRID_QUOTING.md](skills/AGENTS_HYBRID_QUOTING.md) — hybrid quote = execute; Swap + Trade market share `quoteCw20ViaRouteSolve` (#418, #501); hop-offer partition (#1280) [`AGENTS_HYBRID_HOP_OFFER.md`](skills/AGENTS_HYBRID_HOP_OFFER.md); regression `make verify-issue-501` · `make verify-issue-1280`
