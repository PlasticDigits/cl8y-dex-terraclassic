...
- [skills/AGENTS_FRONTEND_CHARTS_PAIR_STATS.md](skills/AGENTS_FRONTEND_CHARTS_PAIR_STATS.md) — `/charts` pair 24h Stats **Vol (USD)** + human token remainder (**P565-1–P565-7**, [#565](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/565)); `make verify-issue-565`
