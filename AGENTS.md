...
- [skills/AGENTS_LP_SYMBOL_DIGITS.md](skills/AGENTS_LP_SYMBOL_DIGITS.md) — LP CW20 ticker classic `[a-zA-Z\-]{3,12}` so UST1/CL8Y `create_pair` does not revert (**F3**, [#518](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/518)); `make verify-issue-518`
