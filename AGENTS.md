...
- [skills/AGENTS_CW20_CODE_ID_PIN.md](skills/AGENTS_CW20_CODE_ID_PIN.md) — listed CW20 `code_id` pin + write-path whitelist re-check so `MsgMigrateContract` cannot leave the listing template (**F6**, [#582](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/582)); `make verify-issue-582`
