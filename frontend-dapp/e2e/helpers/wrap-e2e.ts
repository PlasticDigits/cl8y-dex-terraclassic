...
export async function requirePoolCardWithNativeWrap(page: Page, detail = NATIVE_WRAP_POOL_MSG): Promise<void> {
...
export async function requirePoolCardWithReceiveWrapped(page: Page, detail = RECEIVE_WRAPPED_POOL_MSG): Promise<void> {
