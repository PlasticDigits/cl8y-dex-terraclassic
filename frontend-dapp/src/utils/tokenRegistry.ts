...
/** Columbus-5 registry USDT CW20 (tokenlist). Charts USD pin — identity by contract (#1258). */
export const REGISTRY_USDT_CW20_ADDRESS = 'terra1z0xe7t5ymmltg4vju8tghkq0pewy4et548ta23nlu9zxtl950uyqkv8mv4'
...
export const TOKENS: TokenRegistryEntry[] = [
  ...
  },
  {
    ...
    decimals: 6,
    type: 'native',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/USTC.png',
  },
  {
    symbol: 'CL8Y',
    name: 'CL8Y Token',
    ...
    decimals: 18,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/CL8Y.png',
  },
  {
    symbol: 'USTR',
    name: 'USTR Token',
    decimals: 18,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/USTR.png',
  },
  {
    symbol: 'ALPHA',
    name: 'Alpha Token',
    decimals: 6,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/ALPHA.png',
  },
  {
    symbol: 'USTRIX',
    name: 'USTRIX Token',
    decimals: 6,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/USTRIX.png',
  },
  {
    symbol: 'SpaceUSD',
    name: 'SpaceUSD Token',
    decimals: 6,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/SPACEUSD.png',
  },
  {
    ...
    decimals: 6,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/CLUNC.png',
  },
  {
    symbol: 'cUSTC',
    ...
    decimals: 6,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/CUSTC.png',
  },
  {
    symbol: 'UST1',
    name: 'UST1',
    decimals: 6,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/UST1.png',
  },
  {
    symbol: 'vFDUSD',
    ...
    decimals: 6,
    type: 'cw20',
    logoURI: 'https://git.cl8y.com/code/cl8y-dex-terraclassic/raw/branch/main/tokenlist/images/VFDUSD.png',
  },
  {
    symbol: 'USDT',
    name: 'Tether USD',
...
export const USDT_CW20_ADDRESS = REGISTRY_USDT_CW20_ADDRESS
