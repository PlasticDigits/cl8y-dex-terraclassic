...
export default function NetworkBadge() {
  ...
  return (
    <div
      className="flex items-center gap-1.5 px-2 py-1.5 border-2 border-white/25 shrink-0 shadow-[2px_2px_0_#000]"
    ...
    >
      ...
      <span className="text-[10px] sm:text-xs font-medium uppercase tracking-wide whitespace-nowrap font-heading">
        {shortLabel}
      </span>
    </div>
  )
