...
export function TradePageWorkspaceSkeleton({ includePageChrome = false }: TradePageWorkspaceSkeletonProps) {
  return (
    ...
    >
      ...
      >
        <div className="min-h-[280px] md:col-span-2 md:row-start-2 card-glass !p-3 flex flex-col gap-2">
          <Skeleton height="0.75rem" width="5rem" />
          <Skeleton height="100%" className="flex-1 min-h-[220px]" />
        </div>
        <div className="min-h-[200px] md:col-start-2 md:row-start-1 card-glass !p-3 flex flex-col gap-2">
          <Skeleton height="0.75rem" width="6rem" />
          <Skeleton height="100%" className="flex-1 min-h-[160px]" />
        </div>
        <div className="min-h-[220px] md:min-h-[280px] md:col-start-1 md:row-start-1 card-glass !p-2 flex flex-col gap-2">
          <Skeleton height="0.75rem" width="5rem" />
