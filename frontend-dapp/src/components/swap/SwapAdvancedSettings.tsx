...
export function SwapAdvancedSettings({
  ...
  return (
    ...
    >
      <div data-testid="swap-advanced-settings-details" data-open={open ? 'true' : 'false'}>
        <button
          type="button"
          className="cursor-pointer text-sm font-semibold uppercase tracking-wide text-left w-full"
