...
import type { FeeConfig, HooksResponse, FactoryConfigResponse } from '@/types'
...
/** Pair `GetDiscountRegistry` — `null` means unwired (full pair fee). GitLab #536 / #538. */
export { getPairDiscountRegistry } from './pairDiscountRegistry'
