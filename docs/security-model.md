...
Governance on the **factory** can **pause** individual pairs (`SetPairPaused`) or **blacklist** wallets, tokens, or pairs for incident response ([ADR 0003](adr/0003-governance-trading-blacklist.md)). Copy-pastable `terrad` recipes with confirmation queries: **[`docs/runbooks/emergency-commands.md`](runbooks/emergency-commands.md)** ([SEC-B11](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/399), GitLab [#399](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/399)). **Unpause** requires the prerequisite checklist in section 2 before broadcasting restore (**SEC-G07**, [#440](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/440)). LocalTerra rehearsal: `make verify-issue-399`. Agent playbook: [`skills/AGENTS_EMERGENCY_COMMANDS.md`](../skills/AGENTS_EMERGENCY_COMMANDS.md).
