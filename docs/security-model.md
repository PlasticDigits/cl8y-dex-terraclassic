...
See also: GitLab [#121](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/121), [#276](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/276), [#518](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/518), [`docs/contracts-security-audit.md`](./contracts-security-audit.md) (invariants **F1**, **F2**, **F3**), and factory `lib.rs` / `state.rs` in `smartcontracts/contracts/factory/`.
