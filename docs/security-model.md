...
**LP ticker (GitLab [#518](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/518)):** pair-created LP CW20 symbols are sanitized to classic **`[a-zA-Z\-]{3,12}`** so UST1 / CL8Y pairs do not revert at LP instantiate against columbus-5 `lp_token_code_id`. See invariant **F3** and [`docs/contracts-terraclassic.md` § CreatePair LP ticker](./contracts-terraclassic.md#createpair-lp-ticker-gitlab-518).
