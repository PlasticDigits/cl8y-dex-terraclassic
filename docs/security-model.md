...
Operator checklist (governance, treasury, hooks, router trust, pool-only verification): [`docs/runbooks/launch-checklist.md`](runbooks/launch-checklist.md). Hook registration: [`docs/runbooks/hook-registration.md`](runbooks/hook-registration.md). CW20 whitelist ops: [`docs/runbooks/cw20-code-id-ops.md`](runbooks/cw20-code-id-ops.md).
