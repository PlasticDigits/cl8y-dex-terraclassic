...
Labels shipped in [!1290](https://git.cl8y.com/code/cl8y-dex-terraclassic/pulls/1290) ([#1240](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1240)). The leftover regression entry is `make verify-issue-1290` (alias `verify-issue-1302`): child `verify-issue-1240`, `hubPriceTicker` Vitest, optional Playwright `protocol-page` at 5 workers. Decision, forbidden dirty files, skip vs leftover-complete: [ADR 0008](./adr/0008-verify-issue-1290-hub-wrap-labels.md) ([#1302](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1302)). QA row: [`qa-invariants.md`](./qa-invariants.md) **Q21**. No indexer JSON change.
