...
Labels shipped in [!1290](https://git.cl8y.com/code/cl8y-dex-terraclassic/pulls/1290) ([#1240](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1240)). Leftover issue is **#1302** (not product #1290). Closed !1302 merged a weaker sketch (`f237a6e6`); the follow-up on current `main` lands this section plus ADR 0008 / **Q21** / README index, alias `verify-issue-1302`, `free_tcp_port` 30129, and full B1290-4 greps — do not retarget that closed PR. Bundle: `make verify-issue-1290` (alias `verify-issue-1302`) → child `verify-issue-1240`, `hubPriceTicker` Vitest, optional Playwright `protocol-page` at 5 workers. Decision: [ADR 0008](./adr/0008-verify-issue-1290-hub-wrap-labels.md). QA row: [`qa-invariants.md`](./qa-invariants.md) **Q21**. No indexer JSON change.
