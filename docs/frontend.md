...
| **M626** Migrate Token | `/token/migrate` is free (no invoice). S3/S3-8266 go; 8654 not supported. Create Token links here for **other** templates; launcher 11619 stays CMM-only. |
