...
**Regression tests:** [`tokenSearchQuery.test.ts`](../frontend-dapp/src/utils/__tests__/tokenSearchQuery.test.ts); [`TokenSearchSelect.test.tsx`](../frontend-dapp/src/components/trade/__tests__/TokenSearchSelect.test.tsx); E2E helpers [`e2e/helpers/token-select.ts`](../frontend-dapp/e2e/helpers/token-select.ts) target `combobox` (in-menu `searchbox` when the trigger is a button); mobile CLS [`e2e/swap-token-select-cls.spec.ts`](../frontend-dapp/e2e/swap-token-select-cls.spec.ts) (**#498**); clearance [`e2e/swap-token-select-viewport.spec.ts`](../frontend-dapp/e2e/swap-token-select-viewport.spec.ts) (**#632**); LocalTerra gems-still-listed P1 [`e2e/retail-test-tokens-562.spec.ts`](../frontend-dapp/e2e/retail-test-tokens-562.spec.ts) (**#562** / **#573**).

**Third-party / agent context:** [`skills/AGENTS_FRONTEND_TOKEN_SEARCH.md`](../skills/AGENTS_FRONTEND_TOKEN_SEARCH.md); CLS: [`skills/AGENTS_FRONTEND_PORTAL_LISTBOX_CLS.md`](../skills/AGENTS_FRONTEND_PORTAL_LISTBOX_CLS.md); visual viewport: [`skills/AGENTS_FRONTEND_PORTAL_LISTBOX_VIEWPORT.md`](../skills/AGENTS_FRONTEND_PORTAL_LISTBOX_VIEWPORT.md); keyboard notes in [`skills/AGENTS_FRONTEND_PORTAL_LISTBOX_KEYBOARD.md`](../skills/AGENTS_FRONTEND_PORTAL_LISTBOX_KEYBOARD.md).
