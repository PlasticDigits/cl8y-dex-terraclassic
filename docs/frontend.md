...
| **S1267-1** LCD debit wins | Swap/Trade CTA + mutation block when parsed `TaxPreview.debit > balance`. Classic `amount > balance` stays Insufficient Balance. No pair/router FoT. |
