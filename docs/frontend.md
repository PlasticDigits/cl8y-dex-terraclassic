...
| ID | Invariant |
|----|-----------|
| **T524-1** | Invert is **UI-only**. Do not change indexer `price` / `price_usd`, candle storage, or CG/CMC `last_price`. |
...
**USD invert:** displayed Last = `price_usd / human_price` (or quote catalog for the display leg). Factory `price_usd` remains USD of 1 `asset_0`.

Implementation: [`tradePairDisplayOrientation.ts`](../frontend-dapp/src/utils/tradePairDisplayOrientation.ts), [`usePairDisplayOrientation.ts`](../frontend-dapp/src/hooks/usePairDisplayOrientation.ts), [`PriceChart.tsx`](../frontend-dapp/src/components/charts/PriceChart.tsx), [`priceChartLightweightSeriesSync.ts`](../frontend-dapp/src/components/charts/priceChartLightweightSeriesSync.ts) (invert → `setData`), [`TradeOrderTicket.tsx`](../frontend-dapp/src/components/trade/TradeOrderTicket.tsx). Regression: `make verify-issue-524`.

**Third-party / agent context:** [`skills/AGENTS_FRONTEND_TRADE_PAIR_INVERT.md`](../skills/AGENTS_FRONTEND_TRADE_PAIR_INVERT.md).
