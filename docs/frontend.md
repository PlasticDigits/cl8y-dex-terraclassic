...
| **Hide test-gem performance (#674)** | Default Open Positions, header realized P&amp;L (from those visible rows), and Recent activity **omit** soft-launch gems. **Show test pairs** reveals them under a **Test pairs** divider. See [P674](#portfolio-hide-test-gems). |
