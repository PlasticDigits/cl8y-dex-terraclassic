...
| **T524-6** | Reciprocal safety: drop `≤ 0` / non-finite prices. OHLC invert swaps high/low. Never pass `NaN`/`Infinity` to lightweight-charts ([#226](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/226)). Y-axis stays non-negative ([#151](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/151)). |
...
Implementation: [`tradePairDisplayOrientation.ts`](../frontend-dapp/src/utils/tradePairDisplayOrientation.ts), [`usePairDisplayOrientation.ts`](../frontend-dapp/src/hooks/usePairDisplayOrientation.ts), [`PriceChart.tsx`](../frontend-dapp/src/components/charts/PriceChart.tsx), [`TradeOrderTicket.tsx`](../frontend-dapp/src/components/trade/TradeOrderTicket.tsx). Regression: `make verify-issue-524`.
