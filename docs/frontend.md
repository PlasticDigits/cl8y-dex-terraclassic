...
| **T693-8 Docs** | This section + [`design-system.md`](./design-system.md) + [`AGENTS_FRONTEND_TRADE_TICKET_FLATTEN.md`](../skills/AGENTS_FRONTEND_TRADE_TICKET_FLATTEN.md). Verify: `make verify-issue-693`. |
...
**Verify:** `make verify-issue-692` · `make verify-issue-655` · `make verify-issue-547` · `make verify-issue-662`. Playbooks: [`AGENTS_FRONTEND_POOL_TABLE.md`](../skills/AGENTS_FRONTEND_POOL_TABLE.md), [`AGENTS_INDEXER_PAIR_VOLUME_USD.md`](../skills/AGENTS_INDEXER_PAIR_VOLUME_USD.md), [`AGENTS_INDEXER_PAIR_LIQUIDITY_USD.md`](../skills/AGENTS_INDEXER_PAIR_LIQUIDITY_USD.md), [`AGENTS_FRONTEND_POOL_CREATED.md`](../skills/AGENTS_FRONTEND_POOL_CREATED.md).
