...
## Frontend
- [QuickSwap-inspired blue + gold system](./design-system.md) — design tokens, primitives (`shell-panel`, `card-glass`, `btn-*`, `tab-glass`, …) ([#488](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/488); class rename [#415](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/415))
