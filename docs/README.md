...
- [Incident template (DEX + indexer)](./templates/incident-dex-indexer.md) — operator tracker with audit **timeline** table (SEC-G06, [#439](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/439)); agent playbook [`skills/AGENTS_INCIDENT_TEMPLATE.md`](../skills/AGENTS_INCIDENT_TEMPLATE.md)
