...
| **B1290-4** | Crosslinks: testing, AGENTS, PROTOCOL_STATS, PROTOCOL_HUB, frontend.md, ADR 0009, architecture `#dex-hub-wrap-labels`, this Q22. Follow-up **inserts** those slice-0 sections (do not whole-file checkout overlap files from the design tip); do not shrink greps to the closed-!1302 sketch. |
...
| **B1290-7** | Do not add `frontend-dapp/node_modules`, hook-test FAIL residue, `.gitignore` churn, or `AGENTS_POST_MERGE_OPS_1302.md`. Do not edit `scripts/test-commit-msg-hook.sh`. Do not take ADR 0008 / Q21 (#1300). |
| **B1290-8** | Green skip-E2E ≠ leftover-complete. Leftover-complete is the follow-up wiring MR. Production `/protocol` visual is [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305) leftover 1 (related #1290 AC), not this ticket. No HTML scrape. Not [agent-control #297](https://git.cl8y.com/PlasticDigits/cl8y-agent-control/issues/297). |
...
- [ADR 0009](./adr/0009-verify-issue-1290-hub-wrap-labels.md) — leftover `make verify-issue-1290` hub wrap vs CEX labels ([#1302](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1302), **Q22**); ADR **0008** / **Q21** reserved for leftover-ops [#1300](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1300)
