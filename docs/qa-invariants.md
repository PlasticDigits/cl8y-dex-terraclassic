...
- [ADR 0012](./adr/0012-alpha-pair-price-candles.md) — ALPHA / non-catalog factory price candles ([#1315](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1315)); not a **Q** row
