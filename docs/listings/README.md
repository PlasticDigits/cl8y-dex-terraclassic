...
| **GeckoTerminal** | Terra Classic is **not** in `GET https://api.geckoterminal.com/api/v2/networks`. Path is **Non-EVM** adapters + [Google form](https://forms.gle/zBLCAEv69b8YoFxV6). Vendor under `scripts/geckoterminal/` if we go. |
