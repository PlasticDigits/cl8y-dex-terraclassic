...
| Wrap-enter GET `/route/solve` | [#1218](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1218) | [`make verify-issue-1218`](../Makefile); [`AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md`](../skills/AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md) | **H1218-1–H1218-8** — client wrap-map `uluna`/`uusd` then GET; quote=submit hops; execute pool-only (**H596-7**); indexer skip-unusable while filling K (do not bump `MAX_PATH_CANDIDATES`). Optional `VERIFY_ISSUE_1218_CHAIN=1` wrap-swap E7/E8. |
