...
| Community tax router hops Honest | [#607](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/607) | [`make verify-issue-607`](../Makefile); skill [`AGENTS_COMMUNITY_TAX_ROUTER.md`](../skills/AGENTS_COMMUNITY_TAX_ROUTER.md) | **T592-13** / **C593-14** / **R607-1–R607-8** — C-2 option 1 disclose; pair-direct still taxes; no classify/router wasm change |
