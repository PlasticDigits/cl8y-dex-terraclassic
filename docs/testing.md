...
| F6 upgrade script + freeze runbook | [#584](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/584) | [`make verify-issue-584`](../Makefile); [`scripts/upgrade-582-code-id-pin.sh`](../scripts/upgrade-582-code-id-pin.sh); [`docs/runbooks/cw20-code-id-ops.md`](./runbooks/cw20-code-id-ops.md) | Factory 1.9.0 **before** pair 1.15.0; `limit: 30` + `GetPairCount`; LCD ContractInfo probe; launch **BLOCK** until columbus-5 run |
