...
| Post-merge PRs 1302–1304 leftover verify | [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305) | [`make verify-issue-1305`](../Makefile) (implement); skill [`AGENTS_POST_MERGE_OPS_1305.md`](../skills/AGENTS_POST_MERGE_OPS_1305.md); ADR [`0010-post-merge-leftover-1302-1304.md`](./adr/0010-post-merge-leftover-1302-1304.md) | **M1305-1–M1305-8** / **Q23** — children 1290 (`VERIFY_ISSUE_1290_SKIP_E2E=1` default), 1277; Coolify `20260921130000` heal (manual indexer deploy if #1276 checkbox off) + minify-safe hub HTTP (`cLUNC wrap` / `'cLUNC'` / `'cUSTC'` / `'vFDUSD'`); USD-only heal gate Stay; dismiss then merge; do not reopen #1290 / #1277; do not close #1300; ADR **0008**/**0009** reserved |
