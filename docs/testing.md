...
| Hub wrap vs CEX native labels | [#1290](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1290) | [`make verify-issue-1290`](../Makefile) (extends **#1240** + `hubPriceTicker` Vitest + Playwright `protocol-page`) | Same **P1240** invariants; bundle implement PR for post-merge hub **cLUNC** vs oracle **LUNC** readability |
...
| Post-merge PRs 1302–1304 leftover verify | [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305) | [`make verify-issue-1305`](../Makefile) (implement); skill [`AGENTS_POST_MERGE_OPS_1305.md`](../skills/AGENTS_POST_MERGE_OPS_1305.md); ADR [`0010-post-merge-leftover-1302-1304.md`](./adr/0010-post-merge-leftover-1302-1304.md) | **M1305-1–M1305-8** / **Q23** — children 1290 (`VERIFY_ISSUE_1290_SKIP_E2E=1` default), 1277; make is HTTP-only (not leftover-complete); leftover-1 is glance hub `cUSTC / USD` + `cLUNC / USD` vs CEX `USTC` / `LUNC` / `vFDUSD` / click vFDUSD selected not `VFDUSD` (HTTP `cLUNC` is supporting, not leftover-1); leftover-complete is ADR 0010 close-comment (sqlx SELECT `20260921130000` + heal needle + leftover-1 glance — not `GET /health` / `protocol-top-pairs` / green make); Coolify `20260921130000` startup-before-D5 heal (manual indexer deploy if #1276 checkbox off); USD-only heal gate Stay (**I11**); dismiss then merge; reopen #1305 if still closed on 06:46 comment (not leftover-complete); do not reopen #1290 / #1277; do not close #1300; ADR **0008**/**0009** reserved |
