...
| Trader rolling raw volume type | [#1277](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1277) | [`make verify-issue-1277`](../Makefile); ADR [`0005-trader-rolling-volume-numeric.md`](./adr/0005-trader-rolling-volume-numeric.md); skill [`AGENTS_INDEXER_TRADER_ROLLING_VOLUME.md`](../skills/AGENTS_INDEXER_TRADER_ROLLING_VOLUME.md) | **V1277-1–V1277-8** — `NUMERIC(38, 0)` + `LEAST(10^38-1)` + heal missing senders from `swap_events`; `bd_plain_string`; skip-class fixture. Postgres only. Design: [`design/1277-trader-rolling-volume-numeric.md`](../design/1277-trader-rolling-volume-numeric.md) |
