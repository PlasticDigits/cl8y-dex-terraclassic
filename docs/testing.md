...
| ALPHA pair price candles | [#1315](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1315) | [`make verify-issue-1315`](../Makefile) (implement); [ADR 0012](./adr/0012-alpha-pair-price-candles.md) | USD of the non-catalog leg, or human quote-per-base when neither leg is catalog. No peg. Lib tests + chart vitest. No chain |
