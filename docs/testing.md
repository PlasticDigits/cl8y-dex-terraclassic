...
| Protocol Δ% grouped with headline | [#667](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/667) | [`make verify-issue-667`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | **P667-1–P667-4** — StatBox `.stat-value-row` (`justify-start` / wrap); integer census (`14` not `14.00`); Playwright geometry on e2e-smoke (5 workers). No indexer JSON change. |
