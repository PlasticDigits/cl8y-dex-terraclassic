...
| Protocol mixed-case tickers | [#1240](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1240) | [`make verify-issue-1240`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | **P1240-1–P1240-8** — hub `cUSTC / USD` and oracle `vFDUSD` omit Tailwind `uppercase`; CEX USTC stays distinct; ticker maps / indexer unchanged |
