...
| Wrap+≥2hop USTC→USTR (same envelope) | [#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264) | [`make verify-issue-1264`](../Makefile); [`AGENTS_TERRACLASSIC_GAS.md`](../skills/AGENTS_TERRACLASSIC_GAS.md) | Fixture `wrap_plus_send_2hop_ustc` = **2,710,000**; pool-only (**H596-7**). Columbus-5 AC1 `gas_used` still unmeasured — do not raise combo overhead here. E2E E10 needs LocalTerra. |
