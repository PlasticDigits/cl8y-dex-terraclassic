...
| Limit reprice arrival-at-price FIFO | [#1227](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1227) | [`make verify-issue-1227`](../Makefile); skill [`AGENTS_LIMIT_ORDER_REPRICE_FIFO.md`](../skills/AGENTS_LIMIT_ORDER_REPRICE_FIFO.md) | Invariant **L23** — `UpdateLimitOrderPrice` joins the tail at the new price; same-price no-op; indexer `walk_index`; do not reopen #247 / #424 |
| Hybrid limit placement/fill/cancel gas | [#1329](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1329) | [`make verify-issue-1329`](../Makefile); skill [`AGENTS_HYBRID_LIMIT_GAS.md`](../skills/AGENTS_HYBRID_LIMIT_GAS.md) | **L25** — place/edit envelope and LUNC preflight include the selected insert-step cap; hybrid failure rolls back book fills; query `gas` / `credit` ignored. Optional LocalTerra E2E checks LCD `gas_used < gas_wanted`; Columbus-5 wallet execution remains operator sign-off. |
...
| Listed CW20 `code_id` pin (F6) | [#582](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/582) / [#1234](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1234) / bundle [#1288](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1288) | [`make verify-issue-582`](../Makefile); [`make verify-issue-1234`](../Makefile) (alias [`make verify-issue-1288`](../Makefile)); skill [`AGENTS_CW20_CODE_ID_PIN.md`](../skills/AGENTS_CW20_CODE_ID_PIN.md) | Pair pin + write-path whitelist re-check; `UpdateLimitOrderPrice` + `CleanLimitBook` gated; `asset_code_id_pin_tests::*` |
...
| ALPHA tax-token rotate (store + whitelist) | [#1246](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1246) | [`make verify-issue-1246`](../Makefile); [`scripts/upgrade-1246-alpha.sh`](../scripts/upgrade-1246-alpha.sh) | Store 1.1.0; `AddWhitelistedCodeId` keep **11630**; launcher `token_code_id`; RegisterListedPair / Refresh after CMM `WasmMsg::Migrate`. Never list **8654**. |
...
| Swap/Trade unfunded acquire | [#678](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/678) | [`make verify-issue-678`](../Makefile); skill [`AGENTS_FRONTEND_SWAP_ACQUIRE_GUIDANCE.md`](../skills/AGENTS_FRONTEND_SWAP_ACQUIRE_GUIDANCE.md) | **A678-1–A678-11** — quote-only when disconnected; UST1 Guide uses inverse + window caps; `/ust1` prefill clamp; U1; 5/30/99 gates stay |
| Swap query params | [#711](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/711) | [`make verify-issue-711`](../Makefile); skill [`AGENTS_FRONTEND_SWAP_QUERY_PARAMS.md`](../skills/AGENTS_FRONTEND_SWAP_QUERY_PARAMS.md) | **Q711-1–Q711-8** — `/swap` preserves search; Uniswap/Terra aliases; factory gate; gems/hostile ignore; optional amount; URL rewrite + reverse + Share in [#713](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/713); tokenlist symbols in [#715](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/715) |
| Swap URL sync | [#713](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/713) | [`make verify-issue-713`](../Makefile); skill [`AGENTS_FRONTEND_SWAP_URL_SYNC.md`](../skills/AGENTS_FRONTEND_SWAP_URL_SYNC.md) | **Q713-1–Q713-10** — canonical rewrite, reverse quotes, Swap Share, Create/Trade query prefill |
| Swap tokenlist symbols | [#715](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/715) | [`make verify-issue-715`](../Makefile); skill [`AGENTS_FRONTEND_SWAP_TOKENLIST_SYMBOLS.md`](../skills/AGENTS_FRONTEND_SWAP_TOKENLIST_SYMBOLS.md) | **TL-1–TL-2**, **QS-1–QS-6**, **SH-1–SH-3** — unique ticker CI; `from=UST1`; Share logos |
| Swap unlisted CW20 amount scale | [#1255](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1255) | [`make verify-issue-1255`](../Makefile); skill [`AGENTS_FRONTEND_SWAP_AMOUNT_SCALE.md`](../skills/AGENTS_FRONTEND_SWAP_AMOUNT_SCALE.md) | **Q1255-1–Q1255-8** — fail-closed resolver; LCD `token_info` for picker ids; cache v2; never execute at `?? 6` |
| USTR→USDT quote scale | [#1257](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1257) | [`make verify-issue-1257`](../Makefile); skill [`AGENTS_FRONTEND_SWAP_USTR_USDT_SCALE.md`](../skills/AGENTS_FRONTEND_SWAP_USTR_USDT_SCALE.md) | **Q1257-1–Q1257-8** — wide hop `k`; implausible skip; 18-dec USDT display; Expert does not waive ≥99% |
...
| Community tax SendFrom Sell allowance | [#1228](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1228) | [`make verify-issue-1228`](../Makefile); skill [`AGENTS_COMMUNITY_TAX_CW20.md`](../skills/AGENTS_COMMUNITY_TAX_CW20.md) **T592-2** / **A-allow** | Listed-pair `SendFrom+Swap` deducts `TaxPreview.debit`; allowance == declared `amount` reverts; `TransferFrom` stays 1:1; crate + docs only (live 11611/11619 store+migrate is ops) |
...
| AutoLP / minter settings no-op | [#1237](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1237) | [`make verify-issue-1237`](../Makefile); skill [`AGENTS_COMMUNITY_TAX_CW20.md`](../skills/AGENTS_COMMUNITY_TAX_CW20.md) **T592-4** | Identical sister AutoLP (and identical `minter`) is `NoOpSettings`; Manage Token does not attach equal AutoLP |
...
| Extra-debit Sell submit gate | [#1267](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1267) | [`make verify-issue-1267`](../Makefile); skill [`AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md`](../skills/AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md) | **S1267-1–S1267-8** — typed 100% / reverse offer blocked when `max(TaxPreview.debit, local extra-debit floor) > balance`; Honest LCD cannot enable a 100% tax sell; Max round-trip; pin ≠ sell detector; unknown exempt fail-closed; pair-direct + router; honest/0-bps unchanged; humanize `InsufficientForSellTax`; no wasm/FoT |
| TaxPreview send_msg / hop debit | [#1285](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1285) | [`make verify-issue-1285`](../Makefile); skill [`AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md`](../skills/AGENTS_FRONTEND_EXTRA_DEBIT_SELL.md) | **S1285-1–S1285-4** — pair-direct `Swap` send_msg; router `hop_trader_debit`; Vitest LCD shapes; inline tx humanize |
...
| Migrate Token why-copy | [#670](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/670) | [`make verify-issue-670`](../Makefile); skill [`AGENTS_FRONTEND_TOKEN_MIGRATE.md`](../skills/AGENTS_FRONTEND_TOKEN_MIGRATE.md) **M670**; copy playbook [`AGENTS_FRONTEND_COPY_COGNITIVE_LOAD.md`](../skills/AGENTS_FRONTEND_COPY_COGNITIVE_LOAD.md) | **M670-1–M670-8** — Unlock {X} (today 7, derived) + examples; no Minting; access ≠ enable; smoke `e2e/token-create-migrate-copy.spec.ts` (5 workers); no `e2e-tx` |
...
| Create Token desktop density | [#669](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/669) | [`make verify-issue-669`](../Makefile); skill [`AGENTS_FRONTEND_CREATE_TOKEN_LAYOUT.md`](../skills/AGENTS_FRONTEND_CREATE_TOKEN_LAYOUT.md) | Invariants **C669-1–C669-8** — `/token/create` uses `.app-main` (not a 520px chimney); `md+` paired rows + SKU 2-col; phone single column; layout only (C593/C604/C605 unchanged). Playwright `e2e/create-token-602.spec.ts` (5 workers) when LocalTerra is up; no `e2e-tx` |
...
| Wrap+≥2hop USTC→USTR (same envelope, closed) | [#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264) | [`make verify-issue-1264`](../Makefile); [`AGENTS_TERRACLASSIC_GAS.md`](../skills/AGENTS_TERRACLASSIC_GAS.md); [ADR 0004](./adr/0004-terraclassic-retail-gas-census.md) | **G1264-1–G1264-8** — fixture `wrap_plus_send_2hop_ustc` = **2,710,000**; pool-only (**H596-7**); USTC Max/gas-gate use bank LUNC. Columbus-5 AC1 measured **2,630,228 gas used** at height **30495717**; keep the envelope unchanged. E2E E10 needs LocalTerra (`VERIFY_ISSUE_1264_CHAIN=1`). |
| Wrap-enter GET `/route/solve` | [#1218](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1218) | [`make verify-issue-1218`](../Makefile); [`AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md`](../skills/AGENTS_FRONTEND_WRAP_ENTER_ROUTE_SOLVE.md) | **H1218-1–H1218-8** — client wrap-map `uluna`/`uusd` then GET; quote=submit hops; execute pool-only (**H596-7**); indexer skips unusable candidates while filling K (do not bump `MAX_PATH_CANDIDATES`). The script isolates SQLx history in `dex_indexer_test_1218`. Optional `VERIFY_ISSUE_1218_CHAIN=1` wrap-swap E7/E8. |
| Declared hybrid hop-offer partition | [#1280](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1280) | [`make verify-issue-1280`](../Makefile); [`AGENTS_HYBRID_HOP_OFFER.md`](../skills/AGENTS_HYBRID_HOP_OFFER.md) | Retail GET hop-0-only hybrid; dApp strip + hop0 preflight; wasm sum invariant kept. |
| Pre-push skips `origin/main` policy commits | [#1287](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1287), [#1286](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1286) | [`make verify-issue-1287`](../Makefile); [`make test-commit-msg-hook`](../Makefile); skill [`AGENTS_GIT_COMMIT_HOOKS.md`](../skills/AGENTS_GIT_COMMIT_HOOKS.md) | **G1287-1–G1287-5** — merge `origin/main` then push after #1282 `Co-authored-by` on main; new branch violations still fail. No LocalTerra. |
| Mixed hybrid+pool router gas | [#679](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/679) | [`make verify-issue-679`](../Makefile); skill [`AGENTS_TERRACLASSIC_GAS.md`](../skills/AGENTS_TERRACLASSIC_GAS.md) | **G-AUTO-1–G-AUTO-10** — hops without `hybrid` use pool floors (not 15M); 4-hop mixed **6,785,500** (~192 LUNC) above columbus-5 `gas_used` 5,026,176; hint = broadcast. Station mobile auto-gas residual documented. Optional `VERIFY_ISSUE_679_CHAIN=1`. |
| Retail gas envelope vs wallet auto-fee census | [#1222](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1222) | [`make verify-issue-1222`](../Makefile); ADR [`0004-terraclassic-retail-gas-census.md`](./adr/0004-terraclassic-retail-gas-census.md); skill [`AGENTS_TERRACLASSIC_GAS.md`](../skills/AGENTS_TERRACLASSIC_GAS.md) | **G-CENSUS-1–G-CENSUS-8** — docs-only Stay; dated AB8BE4F7… LCD re-fetch; G0–G7 scored; no production gas-constant / wallet-adapter diff; #123 / #546/#618 / #1209 out of census. No LocalTerra |
| Route solve remaining failures census (closed) | [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), implementation [PR #1289](https://git.cl8y.com/code/cl8y-dex-terraclassic/pulls/1289) | [`make verify-issue-1265`](../Makefile); ADR [`0007-route-solve-remaining-failures.md`](./adr/0007-route-solve-remaining-failures.md); skill [`AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md`](../skills/AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md) | **R-CENSUS-1–R-CENSUS-8** — accepted docs-only Stay; F0–F10 scored; dated 2026-09-21 public GET summaries; wallet sim explicitly unmeasured; native wrap mapping landed under #1218 / PR #1297; #1257/#1264 are closed; #1330 tracks adjacent Swap route-display verification; no solver/quote-path prod diff. No LocalTerra |
| Indexer `/health` git SHA + auto-deploy leftover | [#1276](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1276) | [`make verify-issue-1276`](../Makefile); ADR [`0006-indexer-health-git-sha.md`](./adr/0006-indexer-health-git-sha.md); skill [`AGENTS_INDEXER_HEALTH_GIT_SHA.md`](../skills/AGENTS_INDEXER_HEALTH_GIT_SHA.md) | **H1276-1–H1276-8** — additive `git_sha`; empty/`GIT_SHA` whitespace falls through to `SOURCE_COMMIT`; never copy Coolify `HEAD`/`main` into `GIT_SHA`; ARG/ENV on **runtime** stage **after** `COPY --from=builder`; Coolify checkbox is operator leftover (#297), not inferred from HTTP. Sibling leftover IID/`REQUIRE_LIVE` fail-close on **unreachable**; #1276 leftover-complete **adds** `EXPECT_SHA` under IID/`LEFTOVER_COMPLETE` (**FAIL before curl** if unset/whitespace-only; intentional, not a #701 bug). **Bake presence:** `VERIFY1276_REQUIRE_LIVE=1` without IID/`EXPECT_SHA` may PASS hex `git_sha`. Rollout leftover: `VERIFY1276_REQUIRE_LIVE=1 VERIFY1276_EXPECT_SHA=$(git rev-parse HEAD) make verify-issue-1276`. Issue AC: keep checkbox; strengthen baked-commit to tip-match; leftover does not HTTP-attest the Vite app. Ok-only tests `remove_var` both keys (`generic_health_unchanged`). Watch paths off until leftover closed. Coolify-era rollback is **three-way** (**H1276-7** / `rollback-decision.md`: 2(c) only when `indexer/migrations/revert/<version>_*.down.sql` exists for **every** successful `_sqlx_migrations.version` newer than the prior Coolify baseline **and** restoring the prior image is required; **Partial suffix revert** is still **2(b)**; 2(b) keep schema even if a paired down exists — **no Stop** only for clean ahead; when `idx_reclass` is **2(b)**, **start only the hotfix image**; dirty → **2(a)**: start **only** the restored prior image (already stopped); dirty → **2(c)**: stay stopped through downs / version `DELETE`, then start **only** the prior image; dirty is a sequential `any success=false?` gate: auto-deploy **off** → Coolify **Stop** / scale-to-zero → snapshot → DELETE every success=false → idx_reclass (auto-deploy off is **not** a process stop; then **re-enter the three-way**); do not `DELETE` `_sqlx_migrations` while the N-shipping image can still boot). Unique sqlx version prefixes; first-applied USDT checksum stays `20260916120000`. No LocalTerra. Do not scrape Coolify |
| Pair-direct pool-only vs solver best execution | [Forgejo #707](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/707) | [`make verify-issue-707`](../Makefile); docs [`integrators.md` § Pair swaps](./integrators.md#pair-swap-pool-only-vs-best-execution-forgejo-707); skill [`AGENTS_HYBRID_QUOTING.md`](../skills/AGENTS_HYBRID_QUOTING.md) | **I707-1–I707-7** — current omission semantics, solver `amount_in`, quote=execute, pool-only quote, opt-in greedy, arb explanation, future #718 handoff. Docs/static only; no wasm or LocalTerra. |
| Greedy book-first swap | [#708](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/708) | [`make verify-issue-708`](../Makefile); skill [`AGENTS_GREEDY_BOOK_FIRST.md`](../skills/AGENTS_GREEDY_BOOK_FIRST.md) | **G1–G14** — opt-in `greedy` (not Pattern C split); `hybrid: None` stays pool-only; quote=execute; gas mapped. No LocalTerra. Pair wasm migrate is ops follow-up. |
| Greedy leftover mutex / stop / overflow | [#709](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/709) | [`make verify-issue-709`](../Makefile); skill [`AGENTS_GREEDY_BOOK_FIRST.md`](../skills/AGENTS_GREEDY_BOOK_FIRST.md) | Pair `HybridSimulation` uses `resolve_swap_hybrid_mode` on both fields (**G11**); `greedy_stop=remainder_to_pool`; pool-spot overflow Skip (**A7**). No LocalTerra. |
| Greedy leftover tax / pause / L7 / blacklist | [#710](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/710) | [`make verify-issue-710`](../Makefile); skill [`AGENTS_GREEDY_BOOK_FIRST.md`](../skills/AGENTS_GREEDY_BOOK_FIRST.md) | Community-tax extra-debit (**T592-13**); pause **L6**; blacklist **L19**; AfterSwap book+pool **L7**. No LocalTerra. |
| Observe query extreme-ratio skip | [#1231](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1231) | [`make verify-issue-1231`](../Makefile); skill [`AGENTS_TWAP_OBSERVE_RATIO.md`](../skills/AGENTS_TWAP_OBSERVE_RATIO.md); [`docs/twap-oracle.md`](./twap-oracle.md) | **O1231-1–O1231-6** — Observe extrapolate uses `checked_from_ratio`; skip last cumulatives (not panic / not clamp). Execute `#465` skip unchanged. Cumulative width is [#1224](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1224) / [#1322](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1322). No LocalTerra. Wasm migrate is ops. |
| TWAP cumulative Uint256 | [#1224](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1224), [#1322](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1322) | [`make verify-issue-1224`](../Makefile) · [`make verify-issue-1322`](../Makefile); skill [`AGENTS_TWAP_CUMULATIVE_U256.md`](../skills/AGENTS_TWAP_CUMULATIVE_U256.md); [`docs/twap-oracle.md`](./twap-oracle.md) | **O1322-1–O1322-8** — `price × dt` and the cumulative add are `Uint256`; stored `u128` JSON zero-extends; sums past `2^128` stay the full integer. No wrap, saturate, or skip-and-freeze. `#465` / `#1231` skip unchanged. Pair cw2 **1.18.0**. No LocalTerra for code verification. Columbus-5 migration is ops [#1324](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1324); preflight [#1232](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1232). |
| Columbus-5 pair TWAP migrate + live acceptance | [#1324](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1324) | [`make verify-issue-1324`](../Makefile); [`scripts/upgrade-1324-pair-twap.sh`](../scripts/upgrade-1324-pair-twap.sh); runbook [`pair-twap-uint256-columbus5.md`](runbooks/pair-twap-uint256-columbus5.md); agent skill [`AGENTS_PAIR_TWAP_MIGRATION.md`](../skills/AGENTS_PAIR_TWAP_MIGRATION.md) | Local guards plus read-only live probe; factory stays code 11629, all listed pairs cw2 1.18.0, `OBSERVATIONS` is not rewritten, UST1/USTR `Observe([0,60])` and reserve movement work. Separately verify production indexer evidence/candle fields and dApp chart bundle. 2-of-3 remains human operator work. |
...
| `/pool` Created column relative age | [#662](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/662) | [`make verify-issue-662`](../Makefile); skill [`AGENTS_FRONTEND_POOL_CREATED.md`](../skills/AGENTS_FRONTEND_POOL_CREATED.md) | **P662-1–P662-8** — list JSON `created_at` (first-seen); `sort=created` by that clock; relative age cell; `—` on garbage. Postgres `api_pairs`. Extends [#547](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/547) **P547-4** |
...
| Trader profile Share link | [#665](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/665) | [`make verify-issue-665`](../Makefile); skill [`AGENTS_FRONTEND_SHARE_LINK.md`](../skills/AGENTS_FRONTEND_SHARE_LINK.md) | Invariants **TS-1–TS-13** — canonical `/trader/{addr}` Web Share + `copyToClipboard` fallback; AddressRow stays bech32; no helmet. Playwright `e2e/trader-page.spec.ts` (5 workers) when LocalTerra is up; no `e2e-tx` |
| Hide test-gem portfolio performance | [#674](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/674) | [`make verify-issue-674`](../Makefile); skill [`AGENTS_FRONTEND_PORTFOLIO_TEST_PAIRS.md`](../skills/AGENTS_FRONTEND_PORTFOLIO_TEST_PAIRS.md) | Invariants **P674-1–P674-8** — default-hide Open Positions / header P&L / Recent activity; **Show test pairs** + divider; `/trader` unfiltered. Playwright `e2e/portfolio.spec.ts` (5 workers) when LocalTerra is up; no `e2e-tx` |
| Connected wallet dropdown layout | [#671](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/671) | [`make verify-issue-671`](../Makefile); skill [`AGENTS_FRONTEND_WALLET_CHIP.md`](../skills/AGENTS_FRONTEND_WALLET_CHIP.md) | Invariants **W671-1–W671-8** — `.wallet-menu-item` icon-left + label; truncated `nowrap` header; explorer http(s) only. Playwright `navigation.spec.ts` (5 workers) when LocalTerra is up; no `e2e-tx` |
...
| Multihop AMM protocol fee hops | [#1269](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1269) | [`make verify-issue-1269`](../Makefile); [ADR 0005](./adr/0005-protocol-fee-multihop-hops.md); skill [`AGENTS_INDEXER_PROTOCOL_FEE_HOPS.md`](../skills/AGENTS_INDEXER_PROTOCOL_FEE_HOPS.md) | **F1269-1–F1269-8** / **PFee-14** — pair-scoped `swap_amm` unique; wrap/window NULL partial; backfill from `swap_events.commission_amount`; no `DO UPDATE`. Postgres only |
| Fee-ledger home (pair_creation / invoices / cohort) | [#1213](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1213) | [`make verify-issue-1213`](../Makefile); skill [`AGENTS_INDEXER_FEE_LEDGER_HOME.md`](../skills/AGENTS_INDEXER_FEE_LEDGER_HOME.md) | **L1213-1–L1213-8** — indexer is the ledger; ingest is [#1209](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1209) / [#1210](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1210) / [#1211](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1211). No new `FeeSource` on this epic. No LocalTerra |
| Pair-creation protocol fee ingest | [#1209](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1209) | Pending; checklist [`docs/qa/issue-1209/README.md`](./qa/issue-1209/README.md); parent `make verify-issue-1213`; key `make verify-issue-1269`; skill [`AGENTS_INDEXER_FEE_LEDGER_HOME.md`](../skills/AGENTS_INDEXER_FEE_LEDGER_HOME.md) | **Not implemented on refreshed main**: no `PairCreation` source/parser or `make verify-issue-1209`. Keep open. Inherit #1269 NULL-pair key; exclude gas/refunds/reply/bank duplicate. |
| Indexer HTTP pack (swaps, pools, fees, burns, windows) | [#1204](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1204) | [`make verify-issue-1204`](../Makefile); skill [`AGENTS_INDEXER_HTTP_PACK.md`](../skills/AGENTS_INDEXER_HTTP_PACK.md) | **I1204-1–I1204-8** — [`indexer-http.md`](./indexer-http.md) path table + curls; `ApiDoc` includes `/health`, fee-discount health, blacklist-check. No new routes. No LocalTerra |
| Protocol DEX hub wrap + LUNC column | [#570](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/570) | [`make verify-issue-570`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_HUB.md`](../skills/AGENTS_FRONTEND_PROTOCOL_HUB.md) | Invariants **H11–H16** — cUSTC/cLUNC wrap `AddressRow`; hub `<dt>` **cLUNC / USD** (#1240); LUNC CEX wrap 1:1 mark; CEX tabs native USTC/LUNC |
| Protocol mixed-case tickers | [#1240](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1240) | [`make verify-issue-1240`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | **P1240-1–P1240-8** — hub `cUSTC / USD` + `cLUNC / USD` and oracle `vFDUSD` omit Tailwind `uppercase`; CEX stays **USTC** / **LUNC**; ticker **ids** / indexer unchanged |
...
| Protocol top-5 30d pairs | [#1263](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1263) | [`make verify-issue-1263`](../Makefile); skills [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md), [`AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md`](../skills/AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md) | **P1263-1–P1263-8** / **I1263-1–I1263-8** — `GET /protocol/top-pairs` rollup; gems out; vol/LP `N×` or **—**. Postgres + RTL. No CosmWasm |
| CMM-weighted protocol top-pairs extension | [#1317](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1317) | **Pending implementation; no #1317 verifier exists.** [`make verify-issue-1263`](../Makefile) covers only the existing baseline. Skills [`AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md`](../skills/AGENTS_INDEXER_PROTOCOL_TOP_PAIRS.md), [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | Required before closure: LP-seconds integral + transfer-gap decision; pair-only priced fee stamp; rollup-only GET/schema/cache checks; UI headers, copy, null/legacy payload and phone-width regressions. |
...
| Candle newest-N + interval chip | [#705](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/705) | [`make verify-issue-705`](../Makefile); skill [`AGENTS_INDEXER_CANDLES_NEWEST_N.md`](../skills/AGENTS_INDEXER_CANDLES_NEWEST_N.md) | **C705-1–C705-8** — GET latest `limit` bars ASC; interval `fitContent`; `.price-chart-interval` stronger blue. Postgres for indexer tests; do not disable #568 marks |
| ALPHA pair price candles | [#1315](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1315) | [`make verify-issue-1315`](../Makefile) (implement); [ADR 0012](./adr/0012-alpha-pair-price-candles.md) | USD of the non-catalog leg, or human quote-per-base when neither leg is catalog. Missing catalog print skips the candle. Gap fill is zero-candle pairs only. No peg. Lib tests + chart vitest. No chain |
| CL8Y → UST1 pool-only gas floor | [#1328](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1328) | [`make verify-issue-1328`](../Makefile); [`make measure-issue-1328`](../Makefile); [ADR 0013](./adr/0013-cl8y-ust1-gas-floor.md); skill [`AGENTS_TERRACLASSIC_GAS.md`](../skills/AGENTS_TERRACLASSIC_GAS.md) | Exact two-hop pool-only endpoint route gets 3M above Columbus-5 read-only measured gas. Generic routes stay unchanged. Signed forward swap/no-toast confirmation is a cl8y-pm inbox action. |
...
| Trader positions 18-decimal storage | [#676](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/676) | [`make verify-issue-676`](../Makefile); skill [`AGENTS_INDEXER_TRADER_POSITIONS_DECIMALS.md`](../skills/AGENTS_INDEXER_TRADER_POSITIONS_DECIMALS.md) | **P676-1–P676-8** — `NUMERIC(78, 18)`; `/positions` `trade_count` matches `/trades` on 6/18 and 18/6; rebuild from `swap_events`. Postgres only |
| Portfolio / trader unrealized P&L | [#675](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/675) | [`make verify-issue-675`](../Makefile); skill [`AGENTS_FRONTEND_PORTFOLIO_UNREALIZED.md`](../skills/AGENTS_FRONTEND_PORTFOLIO_UNREALIZED.md) | Invariants **P675-1–P675-8** — hub mark of remaining quote minus on-DEX cost; **No cost basis** when the DEX never saw a buy |
...
| One chrome layer / anti-nesting | [#653](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/653) | [`make verify-issue-653`](../Makefile); skill [`AGENTS_FRONTEND_CHROME_NESTING.md`](../skills/AGENTS_FRONTEND_CHROME_NESTING.md) | Invariants **C653-1–C653-8** — `StatBox variant="flat"` on metric grids; allowlisted Swap IO / single wells / Trade siblings; `check_chrome_nesting.py` |
| Pool Manage four peer actions | [#660](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/660) | [`make verify-issue-660`](../Makefile); skill [`AGENTS_FRONTEND_POOL_MANAGE_IA.md`](../skills/AGENTS_FRONTEND_POOL_MANAGE_IA.md) | Invariants **M660-1–M660-8** — no page-level zap; four Manage tabs; no Advanced disclosure; empty pool points at Provide Liquidity |
| `/pool` v2 LP USD column | [#655](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/655) | [`make verify-issue-655`](../Makefile); skill [`AGENTS_INDEXER_PAIR_LIQUIDITY_USD.md`](../skills/AGENTS_INDEXER_PAIR_LIQUIDITY_USD.md); [`AGENTS_FRONTEND_POOL_TABLE.md`](../skills/AGENTS_FRONTEND_POOL_TABLE.md) | **P655-1–P655-8** — factory AMM TVL from `#569` `protocol_pair_tvl`; `pair_liquidity_usd` rollup JOIN; unpriced omit/`—` **NULLS LAST**; no per-row LCD. Postgres for indexer tests; Playwright `e2e/pool-table-547.spec.ts` P7 (5 workers). Do not raise pair-list `limit` 100→500 |
| `/pool` Vol USD column | [#692](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/692) | [`make verify-issue-692`](../Makefile); skill [`AGENTS_INDEXER_PAIR_VOLUME_USD.md`](../skills/AGENTS_INDEXER_PAIR_VOLUME_USD.md); [`AGENTS_FRONTEND_POOL_TABLE.md`](../skills/AGENTS_FRONTEND_POOL_TABLE.md) | **PVol-1–PVol-8** — 24h flow USD from `pair_volume_24h.volume_usd`; additive `volume_usd_24h`; `sort=volume_usd_24h` **NULLS LAST**; `/pool` Vol + Manage + pair-search badges. Postgres; Playwright `e2e/pool-table-547.spec.ts` (5 workers). Leftover of #544 on pair-list |
| Swap direction seam plate | [#659](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/659) | [`make verify-issue-659`](../Makefile); skill [`AGENTS_FRONTEND_SWAP_DIRECTION_SEAM.md`](../skills/AGENTS_FRONTEND_SWAP_DIRECTION_SEAM.md) | Invariants **S659-1–S659-8** — opaque `--swap-direction-surface` plate + static occluder; Pay/Receive hairline stays; `:focus-visible` ring. Playwright `e2e/swap-direction-seam-659.spec.ts` (`PLAYWRIGHT_SKIP_CHAIN=1`, 5 workers). No LocalTerra |
| Official CL8Y product links (footer) | [#663](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/663) | [`make verify-issue-663`](../Makefile); skill [`AGENTS_FRONTEND_PRODUCT_LINKS.md`](../skills/AGENTS_FRONTEND_PRODUCT_LINKS.md) | Invariants **P663-1–P663-8** — footer Homepage + Bridge HTTPS allowlist; not header More; `noopener noreferrer`; Playwright `e2e/footer-product-links-663.spec.ts` (5 workers, `PLAYWRIGHT_SKIP_CHAIN=1`) |
| Protocol Δ% grouped with headline | [#667](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/667) | [`make verify-issue-667`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | **P667-1–P667-4** — StatBox `.stat-value-row` (`justify-start` / wrap); integer census (`14` not `14.00`); Playwright geometry on e2e-smoke (5 workers). Liquidity is **24h-only** after [#677](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/677). No indexer JSON change. |
| Protocol leftovers (liquidity 24h + x-axis) | [#677](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/677) | [`make verify-issue-677`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | **P569-1** / **P667-2** / **P668-9** — Total liquidity shows one 24h Δ% chip; UTC volume labels every bar or every 2nd (hourly may widen). Playwright `e2e/protocol-page.spec.ts` (5 workers). No overview / wasm change. |
| Protocol UTC Volume / Liquidity / Fees chart | [#689](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/689) | [`make verify-issue-689`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | **P689-1–P689-8** — exclusive metric toggle on the census chart; liquidity stock last-in-bucket; fees flow idle/unpriced; sibling GETs + 60s grain cache. Postgres for indexer tests; Playwright `e2e/protocol-page.spec.ts` (5 workers). No wasm. |
| Protocol Monthly phone x-axis | [#703](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/703) | [`make verify-issue-703`](../Makefile); skill [`AGENTS_FRONTEND_PROTOCOL_STATS.md`](../skills/AGENTS_FRONTEND_PROTOCOL_STATS.md) | **P703-1–P703-8** — phone Monthly last 6–12 UTC months; axis `YY-MM`; no rotated ticks; tooltip stays `YYYY-MM`. Playwright `e2e/protocol-page.spec.ts` phone 390 (5 workers). Keep `verify-issue-677` / `668` / `689` green. No indexer GET change. |
| Trader page global leaderboard | [#657](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/657) | [`make verify-issue-657`](../Makefile); skill [`AGENTS_FRONTEND_TRADER_LEADERBOARD.md`](../skills/AGENTS_FRONTEND_TRADER_LEADERBOARD.md) | Invariants **TL-1–TL-10** — same Charts board last on `/trader` + `/trader/:address`; not `/portfolio`; USD Volume **T553**; Playwright `e2e/trader-page.spec.ts` (5 workers) when LocalTerra is up; no `e2e-tx` |
...
| DeFiLlama UTC-day API + adapter copies | [#631](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/631) | [`make verify-issue-631`](../Makefile); skill [`AGENTS_DEFILLAMA.md`](../skills/AGENTS_DEFILLAMA.md); [`docs/DEFILLAMA.md`](./DEFILLAMA.md) | **L631-1–L631-11** — daily GET rollup (gem/hybrid/fee exclusions); TVL is on-chain `Pool {}` only; upstream Llama PRs are operator follow-up |
| DeFiLlama fees headline + adapter start (closed #687) | [#687](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/687) | [`make verify-issue-687`](../Makefile); skill [`AGENTS_DEFILLAMA.md`](../skills/AGENTS_DEFILLAMA.md); upstream [#8987](https://github.com/DefiLlama/dimension-adapters/pull/8987); ops record [#688](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/688) | **L687-1–L687-8** — headline priced SUM (EFee-6); per-source fail-closed; `start` = first 200 UTC day; METRIC + residual; no 404-as-zero. Gate passed 7/7 on 2026-09-24 |
...
| Charts pair-scoped 24h stats + leaderboard | [#666](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/666) | [`make verify-issue-666`](../Makefile); skill [`AGENTS_FRONTEND_CHARTS_PAIR_SCOPED.md`](../skills/AGENTS_FRONTEND_CHARTS_PAIR_SCOPED.md) | **CS-1–CS-15** — drop DEX census strip; stats below Find pair; `pair=` leaderboard; unscoped `/overview` + `/traders/leaderboard` stay |
| Charts UST1/USD hero + `?price=` | [#680](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/680) | [`make verify-issue-680`](../Makefile); skill [`AGENTS_FRONTEND_CHARTS_UST1_HERO.md`](../skills/AGENTS_FRONTEND_CHARTS_UST1_HERO.md) | **C680-1–C680-9** — UST1/cUSTC hero; Charts default ≠ Trade T524-3; page-wide invert; volume unchanged |
| Charts Select Pair first change | [#1266](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1266) | [`make verify-issue-1266`](../Makefile); skill [`AGENTS_FRONTEND_CHARTS_PAIR_SELECT.md`](../skills/AGENTS_FRONTEND_CHARTS_PAIR_SELECT.md) | **C1266-1–C1266-8** — first `#chart-pair-select` change sticks; idle hero **C680-1** stays; no remount-only pair-switch tests |
...
| Lunc Dash WC payload on dex.cl8y.com | [#1308](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1308) | [`make verify-issue-1308`](../Makefile); skill [`AGENTS_FRONTEND_WALLETCONNECT_MOBILE.md`](../skills/AGENTS_FRONTEND_WALLETCONNECT_MOBILE.md) | **L1308-1–L1308-4** / **Q21** — `buildLuncDashDeepLink` `payload` query + children 519/554. Production device AC (wallet lists `dex.cl8y.com`) after Coolify is cl8y-pm inbox. `VERIFY1308_DEVICE_COMPLETE=1` must FAIL. |
| Leftover Lunc Dash WalletConnect ops verify | [#1279](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1279) | [`make verify-issue-1279`](../Makefile); skill [`AGENTS_OPS_LUNCDASH_VERIFY.md`](../skills/AGENTS_OPS_LUNCDASH_VERIFY.md) | **L1279-1–L1279-8** / **Q20** — pre-check only (always-WC + pairing + UA + legal hint + children 519/554/658). Device QA [`QA_TEMPLATE.md`](../QA_TEMPLATE.md) **1.5** is cl8y-pm inbox cards (at most five taps each). `VERIFY1279_IID=1279` / `LEFTOVER_COMPLETE=1` must FAIL. Do not invent schemes / Leap / ADR-036 / DEX LCD-sim. |
| Legal terms hint not Keplr-only | [#658](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/658) | [`make verify-issue-658`](../Makefile); skill [`AGENTS_FRONTEND_CLICKWRAP.md`](../skills/AGENTS_FRONTEND_CLICKWRAP.md) | **L658-1–L658-8** / **WC-M12** — DEX wallet list or connected wallet; hide on keplr-like injector; no ADR-036 |
...
| Listing venue catalog | [#639](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/639) | [`make verify-issue-639`](../Makefile); skill [`AGENTS_LISTINGS.md`](../skills/AGENTS_LISTINGS.md); [`docs/listings/README.md`](./listings/README.md) | **L639-1–L639-8** — catalog + go/no-go; Keplr pin lockstep; form drafts pin `/cg` `/cmc`; skip Coinhall/DexScreener. No new indexer API on the catalog ticket. No LocalTerra |
| GeckoTerminal `/gt/` adapters | [#646](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/646) | [`make verify-issue-646`](../Makefile); [`scripts/geckoterminal/README.md`](../scripts/geckoterminal/README.md) | Integration API `latest-block` / `asset` / `pair` / `events`. Postgres. Not `/cg/*`. |
| GeckoTerminal `/gt/events` post-event reserves | [#684](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/684) | [`make verify-issue-684`](../Makefile); skill [`AGENTS_INDEXER_GT_EVENT_RESERVES.md`](../skills/AGENTS_INDEXER_GT_EVENT_RESERVES.md) | **R684-1–R684-8** — persist pool-leg post-event `RESERVES`; GET does not JOIN `pair_reserves`; NULL → `"0"`; reverse-apply backfill. Postgres. |
| Indexer API4 per-request caps | [#694](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/694) | [`make verify-issue-694`](../Makefile); skill [`AGENTS_INDEXER_API4_PER_REQUEST.md`](../skills/AGENTS_INDEXER_API4_PER_REQUEST.md) | **A694-1–A694-8** — `/gt/events` row cap 400; progress + blacklist-check on LCD-heavy; discount cache; list caps. Postgres + Vitest. |
| Redacted UTC-day evidence JSON | [#1205](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1205) | [`make verify-issue-1205`](../Makefile); skill [`AGENTS_INDEXER_EVIDENCE_DAILY.md`](../skills/AGENTS_INDEXER_EVIDENCE_DAILY.md) | **E1205-1–E1205-8** — `GET /api/v1/evidence/daily`; surfaces swap/wrap/limit/lp; `actor_hash`; not LCD-heavy. Postgres. |
| CG/CMC listing field truthfulness | [#685](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/685) | [`make verify-issue-685`](../Makefile); skill [`AGENTS_INDEXER_CG_CMC_LISTING.md`](../skills/AGENTS_INDEXER_CG_CMC_LISTING.md); [`docs/CG_CMC_COMPLIANCE.md`](./CG_CMC_COMPLIANCE.md) | **L685-1–L685-8** — `liquidity_in_usd` is AMM TVL stamp not volume; bid/ask not `f64*0.999`; gems omitted; CMC numeric ids + `isFrozen`. Postgres. `#224` stays closed. |
...
| Post-merge !437–!458 leftover verify | [#673](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/673) | [`make verify-issue-673`](../Makefile); skill [`AGENTS_POST_MERGE_OPS_673.md`](../skills/AGENTS_POST_MERGE_OPS_673.md) | **M673-1–M673-8** / **Q15** — children 655–672; Coolify `liquidity_usd` / `created_at` / pair leaderboard 404+400 / volume grains / frontend `8af5563c+`; do not restore Charts census or a second `pair_liquidity.rs`; do not commit `tmp-558-*`; do not reopen #655–#672 |
| Post-merge !459–!468 leftover verify | [#686](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/686) | [`make verify-issue-686`](../Makefile); skill [`AGENTS_POST_MERGE_OPS_686.md`](../skills/AGENTS_POST_MERGE_OPS_686.md) | **M686-1–M686-8** / **Q16** — children 674–680, 683; Coolify `NUMERIC(78,18)` + `economic_token_marks` + `HUB_CL8Y_ADDRESS` / hub four cells / CL8Y fee USD / frontend `36d64528+`; do not reopen #674–#680 / #683; do not expand `/hub-prices`; do not touch #684 |
| Post-merge !474/!475 leftover verify | [#698](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/698) | [`make verify-issue-698`](../Makefile); skill [`AGENTS_POST_MERGE_OPS_698.md`](../skills/AGENTS_POST_MERGE_OPS_698.md) | **M698-1–M698-8** / **Q17** — children 694, 695; Coolify API4 caps + FE-01; `#699`/`#700` are dups; do not reopen #694 / #695 |
| Post-merge !477 leftover verify | [#701](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/701) | [`make verify-issue-701`](../Makefile); skill [`AGENTS_POST_MERGE_OPS_701.md`](../skills/AGENTS_POST_MERGE_OPS_701.md) | **M701-1–M701-8** / **Q18** — child 692; Coolify `pair_volume_24h.volume_usd` + list↔stats + `/pool` Vol USD; do not reopen #692 |
| Post-merge !476 leftover verify | [#702](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/702) | [`make verify-issue-702`](../Makefile); skill [`AGENTS_POST_MERGE_OPS_702.md`](../skills/AGENTS_POST_MERGE_OPS_702.md) | **M702-1–M702-8** / **Q19** — children 693, 563, 653; Coolify `/trade` Market default + flatten; do not reopen #693 |
| Stale lazy-chunk reload after Coolify | [#706](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/706) | [`make verify-issue-706`](../Makefile); skill [`AGENTS_FRONTEND_LAZY_CHUNK_LOAD.md`](../skills/AGENTS_FRONTEND_LAZY_CHUNK_LOAD.md) | **L706-1–L706-8** — one-shot document reload on hashed chunk 404; offline Try Again stays #172; nginx 404 JS not immutable. No LocalTerra |
...
**Manual rollback SQL** (not run by `sqlx migrate`): paired `.down.sql` for selected migrations lives under [`indexer/migrations/revert/`](../indexer/migrations/revert/) — e.g. limit-order lifecycle columns ([GitLab **#142**](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/142)) ship beside [`20260509160000_limit_order_placement_lifecycle.sql`](../indexer/migrations/20260509160000_limit_order_placement_lifecycle.sql). Revert files undo **schema only**; they do **not** `DELETE` `_sqlx_migrations`. After applying `down.sql`, `DELETE FROM _sqlx_migrations WHERE version = <that version>` (**only that row**), matching the local `psql` example in [`rollback-decision.md`](./runbooks/rollback-decision.md) § Indexer (same ledger-delete contract as Coolify **2(c)**). Dirty ledger `DELETE`: auto-deploy **off** → Coolify **Stop** / scale-to-zero → snapshot → DELETE every success=false → idx_reclass (auto-deploy off is **not** a process stop). Coolify **2(c)** also Stop-before-surgery. Coolify **2(c)** only when `indexer/migrations/revert/<version>_*.down.sql` exists for **every** successful `_sqlx_migrations.version` newer than the prior Coolify baseline. Historical files under `revert/` are not a 2(c) selector for a later ahead version. **Partial suffix revert** (only versions that have downs) leaves the ledger **ahead** — still **2(b)**. Several ahead versions: revert **descending**, delete **each** matching ledger row — **only after** that every-version gate. CosmWasm contract migration rollback is separate — [wasm admin migration runbook § Rollback and limitations](./runbooks/wasm-admin-migration.md#rollback-and-limitations-sec-h05) (**SEC-H05**, [#443](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/443)).
