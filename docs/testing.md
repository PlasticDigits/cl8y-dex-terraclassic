...
| LP ticker classic charset | [#518](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/518) | [`make verify-issue-518`](../Makefile); skill [`AGENTS_LP_SYMBOL_DIGITS.md`](../skills/AGENTS_LP_SYMBOL_DIGITS.md) | Invariant **F3** — UST1 / CL8Y `create_pair` must not revert; no chain required |
