...
| Migrate Token adopt + LP gate | [#626](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/626) | [`make verify-issue-626`](../Makefile); skill [`AGENTS_FRONTEND_TOKEN_MIGRATE.md`](../skills/AGENTS_FRONTEND_TOKEN_MIGRATE.md) | **M626-1–M626-12** — free `/token/migrate`; S3/S3-8266 go; S4 ALPHA wipe go (never whitelist 8654); `GetMigrateOrigin` attest; Terraport LP table |
