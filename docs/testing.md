...
| CMM v2 LP fee bps and volume rollover | [#1317](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1317) | `make verify-issue-1317` (implement slice 4); [ADR 0012](./adr/0012-cmm-held-v2-lp-fee-bps.md); skill [`AGENTS_INDEXER_CMM_LP_CENSUS.md`](../skills/AGENTS_INDEXER_CMM_LP_CENSUS.md) | **I1317-1–I1317-8** / **P1317-1–P1317-8** — fixed-anchor share-seconds, trading-fee bps, `N×` rollover. Day-29 refresh must not return spot `500`. Ranking stays #1263. Postgres + RTL. No CosmWasm |
