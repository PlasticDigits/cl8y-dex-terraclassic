...
| Wrap+≥2hop USTC→USTR (same envelope) | [#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264) | [`make verify-issue-1264`](../Makefile); [`AGENTS_TERRACLASSIC_GAS.md`](../skills/AGENTS_TERRACLASSIC_GAS.md) | **G1264-1–G1264-8** — fixture `wrap_plus_send_2hop_ustc` = **2,710,000**; pool-only (**H596-7**); USTC Max/gas-gate use bank LUNC. Columbus-5 AC1 `gas_used` still unmeasured — do not raise combo overhead here. Optional `VERIFY1264_COLUMBUS_TX`. E2E E10 needs LocalTerra (`VERIFY_ISSUE_1264_CHAIN=1`). |
...
| Route solve remaining failures census | [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265) | [`make verify-issue-1265`](../Makefile); ADR [`0007-route-solve-remaining-failures.md`](./adr/0007-route-solve-remaining-failures.md); skill [`AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md`](../skills/AGENTS_INDEXER_HYBRID_BEST_EXECUTION.md) | **R-CENSUS-1–R-CENSUS-8** — docs-only Stay; F0–F10 scored; dated 2026-09-21 public GET summaries; #1218/#1257/#1264 stay owners; #1203/#690/#1222/#1264 out of census; no solver/quote-path prod diff. No LocalTerra |
