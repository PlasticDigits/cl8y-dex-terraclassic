...
| DeFiLlama fees headline + adapter start | [#687](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/687) | [`make verify-issue-687`](../Makefile); skill [`AGENTS_DEFILLAMA.md`](../skills/AGENTS_DEFILLAMA.md) | **L687-1–L687-8** — headline priced SUM (EFee-6); per-source fail-closed; `start` = first 200 UTC day; METRIC + residual; no 404-as-zero |
