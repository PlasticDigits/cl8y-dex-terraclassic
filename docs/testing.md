...
| Multihop AMM protocol fee hops | [#1269](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1269) | [`make verify-issue-1269`](../Makefile); skill [`AGENTS_INDEXER_PROTOCOL_FEE_HOPS.md`](../skills/AGENTS_INDEXER_PROTOCOL_FEE_HOPS.md) | **F1269-1–F1269-8** / **PFee-14** — pair-scoped `swap_amm` unique; wrap/window NULL partial; backfill from `swap_events.commission_amount`; no `DO UPDATE`. Postgres only |
