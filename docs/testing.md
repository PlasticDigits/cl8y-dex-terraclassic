...
| Wrap+≥2hop USTC→USTR (same envelope) | [#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264) | [`make verify-issue-1264`](../Makefile); [`AGENTS_TERRACLASSIC_GAS.md`](../skills/AGENTS_TERRACLASSIC_GAS.md) | **G1264-1–G1264-8** — fixture `wrap_plus_send_2hop_ustc` = **2,710,000**; pool-only (**H596-7**); USTC Max/gas-gate use bank LUNC. Columbus-5 AC1 **measured** (`53B06B65…BAC36`, `gas_used=2630228` under 2,710,000, class not-A/not-B); issue **closed**; do **not** reopen; do not raise combo overhead. Optional LCD pin `VERIFY1264_COLUMBUS_TX=53B06B653D78AF3683F51A065FC640074A3A2E76CAE343A97B3E0F0BD79BAC36`. **#587 LUNC** wrap+2hop still unmeasured. E2E E10 needs LocalTerra (`VERIFY_ISSUE_1264_CHAIN=1`). |
