...
| Create Token SKU init + percent taxes | [#605](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/605) | [`make verify-issue-605`](../Makefile); skill [`AGENTS_FRONTEND_CREATE_TOKEN.md`](../skills/AGENTS_FRONTEND_CREATE_TOKEN.md) | **C605-1–C605-3** — percent 2 dp, SKU init payloads, AutoLP instantiate+bind or refuse |
