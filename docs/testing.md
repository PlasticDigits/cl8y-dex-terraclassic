...
| Indexer `/health` git SHA + auto-deploy leftover | [#1276](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1276) | ADR [`0006-indexer-health-git-sha.md`](./adr/0006-indexer-health-git-sha.md); skill [`AGENTS_INDEXER_HEALTH_GIT_SHA.md`](../skills/AGENTS_INDEXER_HEALTH_GIT_SHA.md); `make verify-issue-1276` lands in the code slice | **H1276-1–H1276-8** — additive `git_sha`; Dockerfile ARG required; Coolify checkbox is operator leftover (#297). No LocalTerra. Do not scrape Coolify logs |
