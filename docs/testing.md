...
| Post-merge PRs 1306/1309/1310 leftover | [#1311](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1311) | [`make verify-issue-1311`](../Makefile) (implement); skill [`AGENTS_POST_MERGE_OPS_1311.md`](../skills/AGENTS_POST_MERGE_OPS_1311.md); ADR [`0011-post-merge-leftover-1306-1309-1310.md`](./adr/0011-post-merge-leftover-1306-1309-1310.md) | **M1311-1–M1311-8** / **Q24** — child **1308**; Coolify frontend `payload` cut then device AC2/AC3/AC7 (inbox 1.5.1 / 1.5.1a / 1.5.1b / 1.5.1c + 1.5.6 / 1.5.7; **AC3** is **1.5.1c**). Green make is not leftover-complete. `VERIFY1308_DEVICE_COMPLETE=1` / `VERIFY1311_DEVICE_COMPLETE=1` / `VERIFY1311_IID=1311` must FAIL. Do not reopen #1279. `/protocol` glance stays [#1305](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1305) leftover 1 |
