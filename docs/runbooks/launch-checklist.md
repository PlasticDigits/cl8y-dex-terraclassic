...
**RAN 2026-08-21** on columbus-5: factory **11602** / cw2 **1.9.0**, every listed pair **11601** / cw2 **1.15.0**, `config.pair_code_id` **11601**, smoke 14/14 ([#584](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/584) close comment). Future F6 wasm upgrades still use [`scripts/upgrade-582-code-id-pin.sh`](../../scripts/upgrade-582-code-id-pin.sh) (factory first, `UpdateConfig { pair_code_id }`, LCD retries). **[#581](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/581) / 8266 REPORT is GO**; DEX 2-of-3 `AddWhitelistedCodeId 8266` **RAN 2026-08-22** (height **30060600**). **[#601](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/601) / 11611 REPORT is GO**; `AddWhitelistedCodeId 11611` **RAN 2026-08-23** (height **30071160**, `GetWhitelistedCodeIds` **`[6036, 8266, 10184, 11611]`**). Do **not** whitelist a LocalTerra store id. Do **not** whitelist ALPHA **8654** or **11612/11613/11614**. SpaceUSD/UST1 create+provide stays on [#558](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/558). Regression: `make verify-issue-582` / `make verify-issue-584` / `make verify-issue-589` / `make verify-issue-592`. Playbook: [`skills/AGENTS_CW20_CODE_ID_PIN.md`](../../skills/AGENTS_CW20_CODE_ID_PIN.md), [`skills/AGENTS_CW20_CODE_ID_AUDIT.md`](../../skills/AGENTS_CW20_CODE_ID_AUDIT.md). Incident / unfreeze: [`cw20-code-id-ops.md`](./cw20-code-id-ops.md). Invariant **F6**.
