...
| Protocol-issued LP tokens (factory `lp_token_code_id`) | Generic “tax on transfer” forks (ALPHA **8654**, mutants). Columbus-5 code 3 (`cw20-legacy`, [#627](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/627)) — REPORT **NO-GO**; do not list from cw2 `cw20-base` |
...
| **Named exception only:** in-repo `cl8y-community-tax-token` after `#589` REPORT **GO** ([#592](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/592) / [#601](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/601)). Columbus-5 **11611** listed 2026-08-23 ([`codeids/11611/REPORT.md`](../../cw20-codeid-audits/codeids/11611/REPORT.md)). Rotate **11619** REPORT is **GO** and listed 2026-08-24 ([`codeids/11619/REPORT.md`](../../cw20-codeid-audits/codeids/11619/REPORT.md)). Inbound pair/router/escrow credit stays **1:1**; sell tax is extra-debit; buy tax is outbound split. This is **not** a license to whitelist other tax tokens. | Pair/router FoT math (**H-01**). Do not whitelist until `cw20-codeid-audits/codeids/<id>/REPORT.md` is GO. The stub [`community-tax-token/REPORT.md`](../../cw20-codeid-audits/codeids/community-tax-token/REPORT.md) is a **NO-GO** placeholder. Do not whitelist launcher **11620** / **11622** or AutoLP **11621**. |
...
This table is a 2026-08-20 snapshot of **pair assets**, not a live probe. Re-query LCD `ContractInfo` (code_id + admin) before Refresh. F6 is live. Factory whitelist 2026-08-24 is **`[6036, 8266, 10184, 11611, 11619]`** (8266 on 2026-08-22; community-tax **11611** on 2026-08-23; rotate **11619** on 2026-08-24). SpaceUSD/UST1 create+provide stays on [#558](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/issues/558).
