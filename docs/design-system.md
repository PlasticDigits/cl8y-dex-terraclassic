...
Default `/limits` place card (#488 reopen): **rate** (“When 1 {token0} is worth”) → **% chips** (0/+1/+5/+10) → **Pay** → **Receive** → **Expiry** (advanced/ladder progressive disclosure). Order book and open placements sit **below** the place card. No instructional paragraphs on the primary card; blocking errors stay visible. Details: [`skills/AGENTS_FRONTEND_LIMIT_ORDER_PRICE.md`](../skills/AGENTS_FRONTEND_LIMIT_ORDER_PRICE.md) · copy rules: [`skills/AGENTS_FRONTEND_COPY_COGNITIVE_LOAD.md`](../skills/AGENTS_FRONTEND_COPY_COGNITIVE_LOAD.md) · agent playbook: [`skills/AGENTS_FRONTEND_DESIGN_SYSTEM.md`](../skills/AGENTS_FRONTEND_DESIGN_SYSTEM.md). On `/trade`, the sticky **Place limit** CTA must stay opaque and keep validation banners in normal flow ([#500](https://gitlab.com/PlasticDigits/cl8y-dex-terraclassic/-/work_items/500); [`skills/AGENTS_FRONTEND_TRADE_LIMIT_STICKY_CTA.md`](../skills/AGENTS_FRONTEND_TRADE_LIMIT_STICKY_CTA.md)).
