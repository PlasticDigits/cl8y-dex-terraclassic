...
- [ADR 0007](./0007-route-solve-remaining-failures.md) — accepted retail GET failure-mode census (closed [#1265](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1265), merged implementation [PR #1289](https://git.cl8y.com/code/cl8y-dex-terraclassic/pulls/1289)); docs-only **Stay**
