...
| [#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264) (code on `main`, PR 1293; issue **closed**) | USTC→USTR wrap+2hop **execute gas** — not quote ranking. AC1 measured (`gas_used=2630228` under 2,710,000, class not-A/not-B); leftover [#1300](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1300) must **not** reopen it |
