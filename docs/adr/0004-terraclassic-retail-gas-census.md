...
- USTC wrap+2hop execute leftover: [#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264) code is on `main` (PR 1293); operator AC1 measured (`53B06B653D78AF3683F51A065FC640074A3A2E76CAE343A97B3E0F0BD79BAC36`, `gas_wanted=2710000`, `gas_used=2630228`, class not-A/not-B); issue **closed**. Keep **2,710,000**; do **not** raise `WRAP_ROUTER_COMBO_OVERHEAD_GAS`. **G1264-4** needs no follow-up after wrap-enter. Stack leftover: [ADR 0008](./0008-post-merge-leftover-1287-1298.md) / [#1300](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1300). Do **not** reopen #1264 from that leftover. Child `make verify-issue-1264` stays in the #1300 stack. Optional `VERIFY1264_COLUMBUS_TX` may pin that hash.
