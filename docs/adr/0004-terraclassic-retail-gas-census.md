...
| Wrap + ≥2hop | wrap + router send N≥2 | **2,710,000** | Yes (native wrap path, pool-only) | same | Gem 2.31M too tight (#587 LUNC). **#1264 USTC AC1** `53B06B65…BAC36` `gas_used=2630228` / wanted 2,710,000 (not-A/not-B); envelope stays. **#587 LUNC** columbus-5 still unmeasured. Leftover must **not** treat this family row as a reopen trigger (**G-CENSUS-2**). |
...
- USTC wrap+2hop execute leftover: [#1264](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1264) code is on `main` (PR 1293); operator AC1 measured (`53B06B653D78AF3683F51A065FC640074A3A2E76CAE343A97B3E0F0BD79BAC36`, `gas_wanted=2710000`, `gas_used=2630228`, class not-A/not-B); issue **closed**. Keep **2,710,000**; do **not** raise `WRAP_ROUTER_COMBO_OVERHEAD_GAS`. **G1264-4** needs no follow-up after wrap-enter. The Wrap+≥2hop inventory cell still lists **#587 LUNC** columbus-5 as unmeasured — leftover must **not** treat that family row as a reopen trigger (**G-CENSUS-2**). Stack leftover: [ADR 0008](./0008-post-merge-leftover-1287-1298.md) / [#1300](https://git.cl8y.com/code/cl8y-dex-terraclassic/issues/1300). Do **not** reopen #1264 from that leftover. Child `make verify-issue-1264` stays in the #1300 stack. Optional `VERIFY1264_COLUMBUS_TX=53B06B653D78AF3683F51A065FC640074A3A2E76CAE343A97B3E0F0BD79BAC36`.
